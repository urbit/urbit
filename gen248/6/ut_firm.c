                        ...
                        u2_noun gib)                              //  retain
  {
    ...
    if ( u2_no == u2_dust(sut) ) switch ( sut ) {
      ...
      case c3__cell: u2_bi_cell(wir_r, u2_t(sut), &p_sut, &q_sut);
      {
        return u2_and
          (u2_dust(gib),
           u2_and(j2_mcx(Pt6, ut, firm)(wir_r, van, p_sut, u2_h(gib)),
                  j2_mcx(Pt6, ut, firm)(wir_r, van, q_sut, u2_t(gib))));
      }
      case c3__core: u2_bi_cell(wir_r, u2_t(sut), &p_sut, &q_sut);
      {
        ...
        if ( u2_nul == u2_h(rq_sut) ) {
          return u2_bl_error(wir_r, "firm-core");
        } else {
          return u2_and
            (u2_dust(gib), 
             u2_and(j2_mcx(Pt6, ut, firm)(wir_r, van, p_sut, u2_h(gib)),
                    u2_sing(prq_sut, u2_t(gib))));
        }
      }
      case c3__cube: u2_bi_cell(wir_r, u2_t(sut), &p_sut, &q_sut);
      {
        return u2_sing(gib, p_sut);
      }
      case c3__face: u2_bi_cell(wir_r, u2_t(sut), &p_sut, &q_sut);
      {
        return j2_mcx(Pt6, ut, firm)(wir_r, van, q_sut, gib);
      }
      case c3__fine: u2_bi_trel(wir_r, u2_t(sut), &p_sut, &q_sut, &r_sut);
      {
        return j2_mcx(Pt6, ut, firm)(wir_r, van, r_sut, gib);
      }
      case c3__fork: u2_bi_cell(wir_r, u2_t(sut), &p_sut, &q_sut);
      {
        return u2_or(j2_mcx(Pt6, ut, firm)(wir_r, van, p_sut, gib),
                     j2_mcx(Pt6, ut, firm)(wir_r, van, q_sut, gib));
      }
      case c3__hold: 
      {
        u2_noun goy = j2_mcy(Pt6, ut, repo)(wir_r, van, sut);
        u2_noun ret = j2_mcx(Pt6, ut, firm)(wir_r, van, goy, gib);
...
*/
                       ...
                       u2_noun cor)                               //  retain
  {
    ...
    if ( (u2_no == u2_mean(cor, u2_cw_con, &van, u2_cw_sam, &gib, 0)) ||
         (u2_none == (sut = u2_frag(u2_cw_sam, van))) )
    {
      return u2_bl_bail(wir_r, c3__fail);
    } else {
      return j2_mcx(Pt6, ut, firm)(wir_r, van, sut, gib);
    }
  }
                        ...
                        u2_noun gib)                              //  retain
  {
    ...
    if ( u2_none == hoc ) {
      ...
      u2_weak cor = u2_rl_molt(wir_r, gat, u2_cw_sam, u2_rx(wir_r, gib), 0);
                        ...
                        u2_noun gib)                              //  retain
  {
    ...
    if ( (jet_j->sat_s & u2_jet_live) && !(jet_j->sat_s & u2_jet_test) ) {
      if ( !(jet_j->sat_s & u2_jet_memo) ) {
        ...
        u2_noun pro   = u2_rl_find_cell(wir_r, fun_m, sut, gib);

        if ( u2_none != pro ) {
          return pro;
        }
        else {
          pro = j2_mcx(Pt6, ut, firm)(wir_r, van, sut, gib);

          return u2_rl_save_cell(wir_r, fun_m, sut, gib, pro);
        }
      }
    }
    else {
      ...
      cor = j2_mci(Pt6, ut, firm)(wir_r, van, sut, gib);
      fol = u2_t(cor);
                        ...
                        u2_noun cor)
  {
         ...
         (u2_none == (sut = u2_frag(u2_cw_sam, van))) )
    {
      ...
      return u2_rc(wir_r, u2_rx(wir_r, sut), u2_rx(wir_r, gib));
    }
  }
