...
#   define _ap_jet_hack  2
    ...
    */
    ...
    _ap_bunt(u3_noun van,
             u3_noun gen)
    {
      u3_noun pro = u3qzl_bunt(van, gen);
    ...
    u3qzp_rake(u3_noun gen)
    {
      ...
      if ( c3y == u3ud(gen) ) {
        ...
        case c3__zpcb: {
          ...
          else return u3qzp_rake(q_gen);
        }
      }
    }
    u3_noun
    u3wzp_rake(u3_noun cor)
    {
      u3_noun gen;
      ...
      if ( c3y == u3du(u3h(gen)) ) {
        ...
        case c3__tsgr: u3x_cell(u3t(gen), &p_gen, &q_gen);
        {
          if ( (c3n == u3du(p_gen)) || (u3_nul != u3h(p_gen)) ) {
            ...
            u3_noun pyr = u3qzp_hack(ter, q_gen);
