...
*/
  ...
  */
    static u3_noun
    _nost_sint(u3_noun, u3_noun, u3_noun, u3_noun, u3_noun, u3_noun, u3_noun);
    static u3_noun
    _nost_dext(u3_noun, u3_noun, u3_noun, u3_noun, u3_noun, u3_noun, u3_noun);

  static u3_noun
  _nost_cram(u3_noun van,
             u3_noun sut,
             u3_noun tel,
             u3_noun ref,
             u3_noun dab,
             ...
             u3_noun gil)
  {
    if ( u3_nul == dab ) {
      ...
      if ( (c3n == _nost_cram(van, sut, tel, ref, l_dab, l_hem, gil)) ||
           (c3n == _nost_cram(van, sut, tel, ref, r_dab, r_hem, gil)) ) 
      {
        return c3n;
      }
        ...
        if ( (c3n == u3du(qn_dab)) || (c3n == u3du(qn_hem)) ) {
          ...
          case c3__ash: {
            if ( c3__ash != u3h(qn_hem) ) {
              ...
              u3_noun ret = _nost_dext(van, vis, tel, lon, u3_nul, u3_nul, gil);
             ...
             u3_noun gil)
  {
    ...
    if ( c3y == u3r_sing(q_sut, q_ref) ) {
      return _nost_dext(van, p_sut, tel, p_ref, u3_nul, u3_nul, gil);
    }
    else if ( (c3n == _nost_dext
                        ...
                        (van, qq_ref, tel, p_ref, u3_nul, u3_nul, gil)) )
    {
      ...
      if ( (pq_sut != pq_ref) && (c3__gold != pq_ref) ) {
        ...
        if ( (c3y == u3qdi_has(gil, hud)) ) {
          ...
          ret = _nost_cram(van, tus, tel, fer, qrq_sut, qrq_ref, zoc);
          u3z(fer);
          u3z(tus);
          u3z(zoc);
          u3z(hud);
          ...
          if ( c3n == ret ) {
            ...
            switch ( pq_sut ) {
              ...
              case c3__gold: {
                return
                  c3a(_nost_dext(van, qq_sut, tel, qq_ref, u3_nul, u3_nul, gil),
                      _nost_dext(van, qq_ref, tel, qq_sut, u3_nul, u3_nul, gil));
              }
              case c3__iron: {
                u3_noun s_sam = u3qfu_peek(van, qq_sut, c3__rite, 2);
                u3_noun r_sam = u3qfu_peek(van, qq_ref, c3__rite, 2);
                u3_noun ret = _nost_dext
                ...
                u3_noun gil)
  {
    ...
    if ( (c3n == u3du(sut)) ) switch ( sut ) {
      ...
      case c3__void: {
        return _nost_sint(van, sut, tel, ref, seg, reg, gil);
      }
    }
    else switch ( u3h(sut) ) {
      default: return u3m_bail(c3__fail);
      ...
      case c3__cell: {
        if ( (c3n == u3r_trel(sut, 0, &p_sut, &q_sut)) ) {
          ...
          if ( c3y == u3r_pq(ref, c3__cell, &p_ref, &q_ref) ) {
            return c3a(_nost_dext(van, p_sut, tel, p_ref, u3_nul, u3_nul, gil),
                       _nost_dext(van, q_sut, tel, q_ref, u3_nul, u3_nul, gil));
          }
          else return _nost_sint(van, sut, tel, ref, seg, reg, gil);
        }
      }
      case c3__core: {
        if ( c3n == u3r_trel(sut, 0, &p_sut, &q_sut) ) {
          ...
          if ( (c3y == u3r_pq(ref, c3__core, &p_ref, &q_ref)) ) {
            return _nost_cong(van, sut, tel, ref, gil);
          }
          else return _nost_sint(van, sut, tel, ref, seg, reg, gil);
        }
      }
      case c3__face: {
        if ( (c3n == u3r_trel(sut, 0, &p_sut, &q_sut)) ) {
          ...
          return _nost_dext(van, q_sut, tel, ref, seg, reg, gil);
        }
      }
      case c3__fork: {
        if ( (c3n == u3r_trel(sut, 0, &p_sut, &q_sut)) ) {
          ...
          if ( c3n == u3du(ref) ) switch ( ref ) {
            default: return _nost_sint(van, sut, tel, ref, seg, reg, gil);
          ...
          return c3o(_nost_dext(van, p_sut, c3n, ref, seg, reg, gil),
                     _nost_dext(van, q_sut, c3n, ref, seg, reg, gil));
        }
      }
      case c3__hold: p_sut = u3t(sut);
      {
        if ( c3y == u3qdi_has(seg, sut) ) {
          ...
          if ( (c3y == u3qdi_has(gil, hud)) ) {
            ...
            u3_noun hiv = _nost_dext(van, fop, tel, ref, gus, reg, zoc);
  ...
  _nost_dext_to(u3_noun van,
                ...
                u3_noun gil)
  {
    u3_noun tyn = _nost_dext_in(van, sut, tel, ref, seg, reg, gil);
             ...
             u3_noun gil)
  {
    ...
    {
      c3_m    fun_m = c3__nost + !!u3r_at(u3qfu_van_vet, van);
      ...
      if ( u3_none != pro ) {
        ...
        pro = _nost_dext_to(van, sut, tel, ref, seg, reg, gil);
    ...
    if ( (c3n == u3du(ref)) ) {
      ...
      switch ( u3h(ref) ) {
        ...
        case c3__core: {
          ...
          u3_noun hiv = _nost_dext(van, sut, tel, gam, seg, reg, gil);
        ...
        case c3__face: {
          if ( c3n == u3r_trel(ref, 0, &p_ref, &q_ref) ) {
            ...
            return _nost_dext(van, sut, tel, q_ref, seg, reg, gil);
          }
        }
        case c3__fork: {
          if ( (c3y == u3r_mean(ref, 6, &p_ref, 7, &q_ref, 0)) ) {
            return c3a(_nost_dext(van, sut, c3n, p_ref, seg, reg, gil),
                       _nost_dext(van, sut, c3n, q_ref, seg, reg, gil));
          }
        ...
        case c3__hold: {
          ...
          }
          {
            ...
            if ( (c3y == u3qdi_has(gil, hud)) ) {
              ...
              {
                u3_noun hiv = _nost_dext(van, sut, tel, gam, seg, gur, zoc);
  ...
  u3_noun
  _cqfu_nost(u3_noun van,
             u3_noun sut,
             u3_noun tel,
             u3_noun ref)
  {
    return _nost_dext(van, sut, tel, ref, u3_nul, u3_nul, u3_nul);
  }

/* boilerplate
*/
  u3_noun
  u3wfu_nost(u3_noun cor)
  {
         ...
         (u3_none == (sut = u3r_at(u3x_sam, van))) )
    {
      ...
      return _cqfu_nost(van, sut, tel, ref);
    }
  }

  u3_noun
  u3qfu_nost(u3_noun van,
             u3_noun sut,
             u3_noun tel,
             u3_noun ref)
  {
