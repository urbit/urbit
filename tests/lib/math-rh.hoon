...
/+  *test, math
|%
++  eh   |=(x=@rh ^-(@ `@`(~(exp rh:math [%n .~~1e-2 .~~0]) x)))
++  lh   |=(x=@rh ^-(@ `@`(~(log rh:math [%n .~~1e-2 .~~0]) x)))
++  sh   |=(x=@rh ^-(@ `@`(~(sin rh:math [%n .~~1e-2 .~~0]) x)))
++  ch   |=(x=@rh ^-(@ `@`(~(cos rh:math [%n .~~1e-2 .~~0]) x)))
++  th   |=(x=@rh ^-(@ `@`(~(tan rh:math [%n .~~1e-2 .~~0]) x)))
++  ath  |=(x=@rh ^-(@ `@`(~(atan rh:math [%n .~~1e-2 .~~0]) x)))
++  ash  |=(x=@rh ^-(@ `@`(~(asin rh:math [%n .~~1e-2 .~~0]) x)))
++  ach  |=(x=@rh ^-(@ `@`(~(acos rh:math [%n .~~1e-2 .~~0]) x)))
++  qh   |=(x=@rh ^-(@ `@`(~(sqt rh:math [%n .~~1e-2 .~~0]) x)))
++  cbh  |=(x=@rh ^-(@ `@`(~(cbt rh:math [%n .~~1e-2 .~~0]) x)))
++  l2h  |=(x=@rh ^-(@ `@`(~(log-2 rh:math [%n .~~1e-2 .~~0]) x)))
++  l10h  |=(x=@rh ^-(@ `@`(~(log-10 rh:math [%n .~~1e-2 .~~0]) x)))
++  ph   |=([x=@rh n=@rh] ^-(@ `@`(~(pow rh:math [%n .~~1e-2 .~~0]) x n)))
