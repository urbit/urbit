...
++  test-chacha
  ...
  ::
    ...
    !>  (chacha 8 key nonce 0 64^0)
  ::
  ::  double-xor should cancel
  ::
    %+  expect-eq
    !>  6^0
    !>  (chacha 12 0x3 0x4 5 (chacha 12 0x3 0x4 5 6^0))
  ::
  ::  ietf
  ::
  ...
  ::
    ...
    !>  (chacha 20 key.x nonce.x 0 32^0)
  ==
--
