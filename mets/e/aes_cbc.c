...
*/
  ...
  u3yea_cbca_en(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &c, 60, &a, 61, &b, 0) ||
      ...
      return u3gea_cbca_en(a, b, c);
    }
  }

  u3_noun
  u3gea_cbca_de(u3_atom key,
                u3_atom iv,
                u3_atom msg)
  {
    c3_y key_y[16];
  ...
  u3yea_cbca_de(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &c, 60, &a, 61, &b, 0) ||
      ...
      return u3gea_cbca_de(a, b, c);
    }
  }

  u3_noun
  u3gea_cbcb_en(u3_atom key,
                u3_atom iv,
                u3_atom msg)
  {
    c3_y key_y[24];
  ...
  u3yea_cbcb_en(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &c, 60, &a, 61, &b, 0) ||
      ...
      return u3gea_cbcb_en(a, b, c);
    }
  }

  u3_noun
  u3gea_cbcb_de(u3_atom key,
                u3_atom iv,
                u3_atom msg)
  {
    c3_y key_y[24];
  ...
  u3yea_cbcb_de(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &c, 60, &a, 61, &b, 0) ||
      ...
      return u3gea_cbcb_de(a, b, c);
    }
  }

  u3_noun
  u3gea_cbcc_en(u3_atom key,
                u3_atom iv,
                u3_atom msg)
  {
    c3_y key_y[32];
  ...
  u3yea_cbcc_en(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &c, 60, &a, 61, &b, 0) ||
      ...
      return u3gea_cbcc_en(a, b, c);
    }
  }

  u3_noun
  u3gea_cbcc_de(u3_atom key,
                u3_atom iv,
                u3_atom msg)
  {
    c3_y key_y[32];
