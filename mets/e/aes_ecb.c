...
*/
  ...
  u3yea_ecba_en(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &b, u3x_con_sam, &a, 0) ||
      ...
      return u3gea_ecba_en(a, b);
    }
  }

  u3_noun
  u3gea_ecba_de(u3_atom key,
                u3_atom blk)
  {
    c3_y key_y[16];
    c3_y blk_y[16];
  ...
  u3yea_ecba_de(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &b, u3x_con_sam, &a, 0) ||
      ...
      return u3gea_ecba_de(a, b);
    }
  }

  u3_noun
  u3gea_ecbb_en(u3_atom key,
                u3_atom blk)
  {
    c3_y key_y[24];
    c3_y blk_y[16];
  ...
  u3yea_ecbb_en(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &b, u3x_con_sam, &a, 0) ||
      ...
      return u3gea_ecbb_en(a, b);
    }
  }

  u3_noun
  u3gea_ecbb_de(u3_atom key,
                u3_atom blk)
  {
    c3_y key_y[24];
    c3_y blk_y[16];
  ...
  u3yea_ecbb_de(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &b, u3x_con_sam, &a, 0) ||
      ...
      return u3gea_ecbb_de(a, b);
    }
  }

  u3_noun
  u3gea_ecbc_en(u3_atom key,
                u3_atom blk)
  {
    c3_y key_y[32];
    c3_y blk_y[16];
  ...
  u3yea_ecbc_en(u3_noun cor)
  {
    ...
    if ( c3n == u3r_mean(cor, u3x_sam, &b, u3x_con_sam, &a, 0) ||
      ...
      return u3gea_ecbc_en(a, b);
    }
  }

  u3_noun
  u3gea_ecbc_de(u3_atom key,
                u3_atom blk)
  {
    c3_y key_y[32];
    c3_y blk_y[16];
