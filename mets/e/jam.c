...
*/
               ...
               u3_noun       l)
  {
    ...
    {
      u3_noun y = u3ga_add(x, p_d);
      u3_noun e = _jam_in(har_p, t_a, y, q_d);
      u3_noun p_e, q_e, r_e;

      u3r_trel(e, &p_e, &q_e, &r_e);
      {
        u3_noun z = u3ga_add(p_d, p_e);

        r = u3nt(u3ga_add(2, z), u3k(q_e), 0);
  ...
  _jam_in_flat(u3p(u3h_root) har_p,
               ...
               u3_noun       l)
  {
    u3_noun d = u3ge_mat(a);
    u3_noun x = u3ga_add(1, u3h(d));
    u3_noun y = u3nt
      (u3k(x), u3nc(u3nc(x, u3gc_lsh(0, 1, u3t(d))), u3k(l)), 0);
  ...
  _jam_in_ptr(u3p(u3h_root) har_p,
              ...
              u3_noun       l)
  {
    u3_noun d = u3ge_mat(u_c);
    u3_atom x = u3gc_lsh(0, 2, u3t(d));
    u3_atom y = u3ga_add(2, u3h(d));
    u3_noun z = u3nt
      (u3k(y), u3nc(u3nc(y, u3gc_mix(3, x)), u3k(l)), 0);
  ...
  u3ge_jam(u3_atom a)
  {
    ...
    u3_noun q = u3gb_flop(u3h(u3t(x)));
    u3_noun r = u3gc_can(0, q);
