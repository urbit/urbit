            ...
            u3_noun b)
  {
    if ( u3_nul == a ) {
      ...
      if ( (c3n == u3r_cell(a, &n_a, &lr_a)) ) {
        ...
        if ( c3n == u3r_cell(lr_a, &l_a, &r_a) ) {
        ...
        else if ( c3y == u3gc_hor(n_b, n_a) ) {
          return u3gdi_uni(u3gdi_int(l_a,
                                     u3nt(n_b,
                                          l_b,
                                          u3_nul)),
                           u3gdi_int(a,
          ...
          return u3gdi_uni(u3gdi_int(r_a,
                                     u3nt(n_b,
                                          u3_nul,
                                          r_b)),
                           u3gdi_int(a,
