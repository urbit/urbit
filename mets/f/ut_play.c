...
# define _play_used()
             ...
             u3_noun rag)
  {
    while ( 1 ) {
      if ( c3n == u3du(mew) ) {
        ...
        u3_noun ruz = u3gfu_toss(van, sut, pi_mew, laf, rag);
                 ...
                 u3_noun rig)
  {
    ...
    u3_noun ret = u3gfu_fire(van, sut, rag);
           ...
           u3_noun gen)
  {
    ...
    if ( c3n == u3du(gen) ) {
      ...
      _play_used();
      {
        ...
        u3_noun pro = u3gfu_wrap(van, boc, c3__iron);
      ...
      {
        u3_noun boc = _play_x(van, sut, p_gen);
        u3_noun pro = u3gfu_wrap(van, boc, c3__zinc);
      ...
      {
        u3_noun boc = _play_x(van, sut, p_gen);
        u3_noun pro = u3gfu_wrap(van, boc, c3__lead);
      ...
      _play_used();
      {
        ...
        u3_noun ret = u3gf_help(p_gen, boc);
      ...
      {
        u3_noun boc = _play_x(van, sut, q_gen);
        u3_noun ret = u3gfu_conk(van, boc, p_gen);
