...
*/
  ...
  _fuse_repo(u3_noun van,
             ...
             u3_noun bix)
  {
    u3_noun rep = u3gfu_repo(van, sut);
           ...
           u3_noun bix)
  {
    ...
    if ( c3n == u3du(sut) ) switch ( sut ) {
      ...
      case c3__atom: u3x_cell(u3t(sut), &p_sut, &q_sut);
      {
        if ( c3y == u3du(ref) ) {
          if ( c3__atom == u3h(ref) ) {
            ...
            {
              u3_noun foc = (c3y == u3gf_fitz(p_ref, p_sut))
                              ? u3k(p_sut)
                              : u3k(p_ref);
      ...
      case c3__help: u3x_cell(u3t(sut), &p_sut, &q_sut);
      {
        ...
        u3_noun ret = u3gf_help(p_sut, vot);
      ...
      {
        u3_noun vot = _fuse_in(van, q_sut, ref, bix);
        u3_noun ret = u3gf_face(p_sut, vot);
      ...
      case c3__fork: p_sut = u3t(sut);
      {
        ...
        u3_noun ret = u3lf_fork(_fuse_in_fork(van, yed, ref, bix));
      ...
      case c3__hold:
      {
        ...
        if ( c3y == u3gdi_has(bix, hud) ) {
          //  u3_noun dun = u3gfu_dunq(van, "type", sut);
          //  u3_noun niz = u3gfu_dunq(van, "over", ref);
...
*/
  ...
  u3_noun
  u3gfu_fuse(u3_noun van,
             u3_noun sut,
             u3_noun ref)
  {
    c3_m    fun_m = 144 + c3__fuse + ((!!u3r_at(u3gfu_van_vet, van)) << 8);
