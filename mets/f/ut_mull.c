...
*/
  ...
  _mull_bean()
  {
    return u3lf_fork(u3nt(u3nq(c3__atom, 'f', u3_nul, 0),
  ...
  _mull_doke(u3_noun van,
             ...
             u3_noun gen)
  {
    u3_noun fug = u3gfu_mint(van, sut, c3__noun, gen);
  ...
  _mull_nice(u3_noun van,
             ...
             u3_noun typ)
  {
    if ( c3n == u3gfu_nest(van, gol, c3y, typ) ) {
      // u3_noun dun = u3gfu_dunq(van, "need", gol);
      // u3_noun niz = u3gfu_dunq(van, "have", typ);
             ...
             u3_noun q_yom)
  {
    while ( 1 ) {
      if ( c3n == u3du(mew) ) {
        ...
        u3_noun cuf = u3gfu_toss(van, sut, pi_mew, p_zil, p_yom);
        u3_noun dof = u3gfu_toss(van, sut, pi_mew, q_zil, q_yom);
  ...
  _mull_cnts_old(u3_noun van,
                 ...
                 u3_noun rig)
  {
    u3_noun lar = u3gfu_seek(van, sut, c3__read, hyp);
    u3_noun vug = u3gfu_seek(van, dox, c3__read, hyp);
    ...
    }
    {
      ...
      u3_noun yom = _mull_edit
        (van, sut, dox, mew, u3k(qq_lar),
                                    u3k(qq_vug));
      u3_noun von = u3i_molt(u3k(van), u3gfu_van_vet, c3n, 0);
      u3_noun p_ret = u3gfu_fire(van, sut, u3h(yom));
      u3_noun q_ret = u3gfu_fire(von, sut, u3t(yom));
...
# define _mull_used()
           ...
           u3_noun gen)
  {
    ...
    if ( c3n == u3du(gen) ) {
      ...
      u3_noun rex = u3gfp_open(ter, gen);
      ...
      _mull_used();
      {
        ...
        u3_noun dis = u3gf_cell(u3h(hed), u3h(tal));
        u3_noun dat = u3gf_cell(u3t(hed), u3t(tal));
...
#if 1
          u3_noun zix = u3gfu_shep(van, "gene", 'q', u3k(gen));
      ...
      _mull_used();
      {
        ...
        u3_noun nob = u3gfl_bunt(van, heb);
        u3_noun p_waz = u3gfu_play(van, sut, nob);
        u3_noun q_waz = u3gfu_play(van, dox, nob);
        u3_noun dok   = u3nc(c3__wing, u3k(q_gen));
        u3_noun p_syx = _mull_doke(van, sut, dok);
        u3_noun q_syx = _mull_doke(van, dox, dok);
        u3_noun p_pov = u3gfu_fish(van, p_waz, p_syx);
        u3_noun q_pov = u3gfu_fish(van, q_waz, q_syx);
      ...
      _mull_used();
      {
        ...
        u3_noun p_fex = u3gfu_gain(van, sut, p_gen);
        u3_noun q_fex = u3gfu_gain(van, dox, p_gen);
        u3_noun p_wux = u3gfu_lose(van, sut, p_gen);
        u3_noun q_wux = u3gfu_lose(van, dox, p_gen);
        u3_noun hiq, ran;
        u3_noun dis, dat;
        u3_noun ret;
      ...
      _mull_used();
      {
        u3_noun typ = u3gfu_play(van, sut, gen);
      ...
      _mull_used();
      {
        ...
        u3_noun pro = u3nc(u3gfu_wrap(van, 
                                      u3h(vat),
                                      c3__iron),
                           u3gfu_wrap(van, 
                                      u3t(vat),
      ...
      _mull_used();
      {
        ...
        u3_noun ret = u3nc(u3gf_help(p_gen, u3h(vat)),
                           u3gf_help(p_gen, u3t(vat)));
      ...
      {
        u3_noun vat = _mull_in(van, sut, gol, dox, q_gen);
        u3_noun ret = u3nc(u3gfu_conk(van, u3h(vat), p_gen),
                           u3gfu_conk(van, u3t(vat), p_gen));
      ...
      _mull_used();
      {
        return u3nc(u3gf_face(p_gen, sut), 
                    u3gf_face(p_gen, dox));
      }
      ...
      _mull_used();
      {
        u3_noun p_hif = _mull_nice(van, gol, u3gfu_play(van, sut, p_gen));
        u3_noun q_hif = u3gfu_play(van, dox, p_gen);
      ...
      _mull_used();
      {
        u3_noun boc = u3gfu_buss(van, sut, p_gen, q_gen);
        u3_noun nuf = u3gfu_buss(van, dox, p_gen, q_gen);
      ...
      _mull_used();
      {
        u3_noun boc = u3gfu_busk(van, sut, p_gen);
        u3_noun nuf = u3gfu_busk(van, dox, p_gen);
      ...
      _mull_used();
      {
        u3_noun typ = u3gfu_play(van, sut, p_gen);
        u3_noun dug = u3gfu_duck(van, typ);
        u3_noun ret;
      ...
      _mull_used();
      {
        u3_noun p_ret = u3gfu_play(van, sut, p_gen);
        u3_noun q_ret = u3gfu_play(van, sut, q_gen);
      ...
      _mull_used();
      {
        u3_noun von = u3i_molt(u3k(van), u3gfu_van_fab, c3n, 0);
      ...
      _mull_used();
      {
        u3_noun p_zur = u3gfu_play(van, sut, p_gen);
        u3_noun q_zur = u3gfu_play (van, dox, p_gen);
        u3_noun vos = _mull_in(van, sut, c3__noun, dox, q_gen);
        u3_noun p_ret = u3gf_cell(p_zur, u3h(vos));
        u3_noun q_ret = u3gf_cell(q_zur, u3t(vos));
...
*/
  ...
  u3_noun
  u3gfu_mull(u3_noun van,
             u3_noun sut,
             u3_noun gol,
             u3_noun dox,
             u3_noun gen)
  {
    c3_m    fun_m = 144 + c3__mull + ((!!u3r_at(u3gfu_van_vet, van)) << 8);
