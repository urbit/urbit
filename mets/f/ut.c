...
#include "all.h"
...
#if 0
    u3_pier_tank(0, u3n_kick_on(u3gfu_dunq(van, ugh_c, typ)));
#endif
  }
  ...
  //
  u3_noun
  u3gfu_shep(u3_noun     van,
             const c3_c* paz_c,
             u3_noun     sty,
             u3_noun     mol)
  {
    return u3gfu_shew(van,
