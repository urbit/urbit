    ...
    if ( c3n == u3du(sut) ) switch ( sut ) {
      ...
      case c3__cell: u3x_cell(u3t(sut), &p_sut, &q_sut);
      {
        if ( c3__atom == u3h(ref) ) {
          ...
          if ( c3y == u3gfu_nest(van, p_ref, c3n, p_sut) )
          {
            u3_noun foz = _crop_dext(van, q_sut, q_ref, bix);
            u3_noun ret = u3gf_cell(p_sut, foz);
      ...
      case c3__help: u3x_cell(u3t(sut), &p_sut, &q_sut);
      {
        ...
        u3_noun ret = u3gf_help(p_sut, foz);
      ...
      {
        u3_noun foz = _crop_dext(van, q_sut, ref, bix);
        u3_noun ret = u3gf_face(p_sut, foz);
      ...
      case c3__fork: p_sut = u3t(sut);
      {
        ...
        u3_noun ret = u3lf_fork(_crop_dext_fork(van, yed, ref, bix));
...
#         endif
             ...
             u3_noun bix)
  {
    ...
    switch ( u3h(ref) ) {
      ...
      case c3__hold:
      {
        u3_noun rep = u3gfu_repo(van, ref);
...
*/
  ...
  u3_noun
  u3gfu_crop(u3_noun van,
             u3_noun sut,
             u3_noun ref)
  {
    c3_m    fun_m = 144 + c3__crop + ((!!u3r_at(u3gfu_van_vet, van)) << 8);
