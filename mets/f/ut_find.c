...
#include "all.h"
             ...
             u3_noun b)
  {
    if ( c3y == u3r_sing(a, b) ) {
      ...
      return u3lb_weld(u3k(a), u3nc(c3_s2('|', '|'), u3k(b)));
    }
  }
                  ...
                  u3_noun gil)
  {
    ...
    u3x_cell(sq_sut, &psq_sut, &qsq_sut);
    {
      if ( u3_nul == q_heg ) {
        ...
        u3_noun zem = u3gf_loot(u3t(q_heg), qsq_sut);
        ...
        if ( u3_nul != zem ) {
          ...
          u3_noun pec = u3gfu_peel(van, sut, way, pq_sut);
          u3_noun pro;
          ...
          if ( c3n == u3h(pec) ) {
            ...
            u3_noun sam = u3gfu_peek(van, p_sut, way, 2);
            u3_noun exa = u3gc_peg(axe, 6);
      ...
      if ( (c3n != u3h(yor)) ) {
        ...
        if ( (c3n != u3h(p_hax)) || (c3n != u3h(p_yor)) ) {
          ...
          return u3nq(c3n,
                      ...
                      u3nc(
                        u3lf_fork(u3nt(u3k(pqpp_hax), u3k(pqpp_yor), u3_nul)),
                        u3k(qqpp_hax)));
        }
      }
    }
            ...
            if ( c3n == u3r_sing(pqqp_hax, pqqp_yor) ) {
              ...
              return 
                u3nq(c3y, 
                     u3_nul,
                     u3k(pqp_hax),
                     u3nt(c3n, u3k(pqqp_hax), u3gdi_uni(qqqp_hax, qqqp_yor)));
            }
          }
        }
      }
                       ...
                       u3_noun gil)
  {
    ...
    // if ( 1 ) {
      ...
      u3_noun tiv = u3gfu_mint            //  (pair span nock)
      ...
      if ( u3_nul == fid ) {
        ...
        ret = u3nq
          (c3n, 
           c3n, 
           wan,
           u3nc(u3k(u3h(vat)), u3gf_comb(u3gf_comb(dog, q_tiv), u3t(vat))));
                  ...
                  u3_noun gil)
  {
    ...
    if ( u3_nul == q_heg ) {
      ...
      if ( c3y == u3ud(qp_sut) ) {
        ...
        u3_noun tyr = u3gdb_get(pqp_sut, uq_heg);  //  (unit {wain (unit twig)})
        ...
        if ( u3_nul == tyr ) {
          ...
          if ( u3_nul == qu_tyr ) {
            ...
            u3_noun tor = u3gfu_fund(van, sut, way, uqu_tyr);
            ...
            if ( c3y == u3h(tor) ) {
              ...
              ret = u3nq(c3y, u3_nul, u3gb_weld(pp_tor, nol), u3k(qp_tor));
              u3z(nol);
              u3z(tor); 
              u3z(tyr);
              return ret;
              ...
              ret = u3nq(c3n, 
                         c3n, 
                         u3k(pu_tyr),
                         u3nc(u3k(pp_tor), u3gf_comb(dog, qp_tor)));
              u3z(dog);
              u3z(tor); 
              u3z(tyr);
             ...
             u3_noun gil)
  {
    if ( c3n == u3du(sut) ) switch ( sut ) {
      ...
      {
        // fprintf(stderr, "hold\r\n");
        if ( (c3y == u3gdi_has(gil, sut)) ) {
          return u3_nul;
        }
        else {
          u3_noun zoc = u3gdi_put(gil, sut);
          u3_noun fop = u3gfu_repo(van, sut);
             ...
             u3_noun p_mor)                //  {wain palo}
  {
    ...
    {
      u3_noun ref    = u3gfu_felt(van, sut, qqp_mor);
      ...
      if ( c3y == u3h(heg) ) {
        ...
        ret = u3nq
          (c3y,
           ...
           u3nc(c3y, u3gfu_peek(van, ref, way, p_heg)));
      }
      else {
    ...
    if ( u3_nul == hyp ) {
      ...
      if ( c3n == u3h(mor) ) {
        ...
        if ( c3y == u3h(p_mor) ) {
          ...
          u3_noun fex = u3gfu_mint(van, pqpp_mor, c3__noun, gen);
          u3_noun ret = u3nq(c3n, 
                             c3n,
                             u3k(ppp_mor),
                             u3nc(u3k(u3h(fex)),
                                  u3gf_comb(qqpp_mor, u3t(fex))));
          u3z(fex);
          u3z(gen);
          u3z(mor);
...
*/
  ...
  u3_noun
  u3gfu_find(u3_noun van,
             u3_noun sut,
             u3_noun way,
             u3_noun hyp)
  {
    c3_m    fun_m = 144 + c3__find + ((!!u3r_at(u3gfu_van_vet, van)) << 8);
...
*/
  ...
  u3_noun
  u3gfu_fond(u3_noun van,
             u3_noun sut,
             u3_noun way,
             u3_noun hyp)
  {
    c3_m    fun_m = 144 + c3__fond + ((!!u3r_at(u3gfu_van_vet, van)) << 8);
    u3_noun pro   = u3z_find_3(fun_m, sut, way, hyp);
