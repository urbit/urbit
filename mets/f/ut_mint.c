...
*/
             ...
             u3_noun typ)
  {
    if ( (c3y == _mint_vet(van)) &&
         (c3n == u3gfu_nest(van, gol, c3y, typ)) )
    {
             ...
             u3_noun gen)
  {
    ...
    switch ( tov ) {
      ...
      case c3y:
        von = u3k(van); break;
      case c3n:
        von = u3i_molt(u3k(van), u3gfu_van_vet, c3n, 0); break;
    }
    {
      u3_noun mil = u3gfu_mint(von, sut, c3__noun, gen);
      u3_noun fol = u3k(u3t(mil));
             ...
             u3_noun hej)
  {
    while ( 1 ) {
      if ( c3n == u3du(mew) ) {
        u3_noun gim = u3gfu_fire(van, sut, rag);
        u3_noun fol = u3gf_hike(p_lar, hej);
        ...
        u3_noun zil = u3gfu_mint(van, sut, c3__noun, qi_mew);
        u3_noun p_zil = u3h(zil);
        u3_noun q_zil = u3t(zil);
        u3_noun wip = u3gfu_toss(van, sut, pi_mew, p_zil, rag);
           ...
           u3_noun gen)
  {
    ...
    if ( c3n == u3du(gen) ) {
      ...
      _mint_used();
      {
        ...
        u3_noun typ = u3gf_cell(u3h(hed), u3h(tal));
      ...
      _mint_used();
      {
        ...
        u3_noun wam = u3gfu_play(van, sut, nob);

        ret = u3nc(_mint_nice(van, gol, _mint_bean()),
                   u3gfu_fish(van, wam, axe));
      ...
      _mint_used();
      {
        ...
        if ( (c3y == _mint_vet(van)) &&
             (c3n == u3gfu_nest(van, u3h(one), c3n, u3h(two))) &&
             (c3n == u3gfu_nest(van, u3h(two), c3y, u3h(one))) )
        {
      ...
      _mint_used();
      {
        ...
        u3_noun tyf = u3gfu_wrap(van, u3h(ryd), c3__iron);
      ...
      {
        u3_noun ryd = _mint_in(van, sut, gol, p_gen);
        u3_noun tyf = u3gfu_wrap(van, u3h(ryd), c3__zinc);
        u3_noun pro = u3nc(tyf, u3k(u3t(ryd)));
      ...
      {
        u3_noun ryd = _mint_in(van, sut, gol, p_gen);
        u3_noun tyf = u3gfu_wrap(van, u3h(ryd), c3__lead);
        u3_noun pro = u3nc(tyf, u3k(u3t(ryd)));
      ...
      _mint_used();
      {
        ...
        u3_noun ret = u3nc(u3gf_help(p_gen, u3k(u3h(hum))),
                           u3k(u3t(hum)));
        u3z(hum);
        return ret;
      }
      ...
      _mint_used();
      {
        ...
        ret = u3nc(u3gfu_conk(van, u3h(vat), p_gen),
                   u3k(u3t(vat)));
      ...
      _mint_used();
      {
        return u3nc(u3gf_face(p_gen, sut), u3nc(0, 1));
      }
      ...
      _mint_used();
      {
        ...
        {
          u3_noun cag = u3gfu_burn(van, sut);
      ...
      _mint_used();
      {
        u3_noun huz = u3gfu_play(van, sut, p_gen);
      ...
      _mint_used();
      {
        if ( c3y == _mint_vet(van) ) {
          u3_noun zur = u3gfu_play(van, sut, p_gen);
          u3_noun dun = u3gfu_dunq(van, "lost", zur);
...
*/
  ...
  u3_noun
  u3gfu_mint(u3_noun van,
             u3_noun sut,
             u3_noun gol,
             u3_noun gen)
  {
    c3_m    fun_m = 144 + c3__mint;
    u3_noun vrf   = u3r_at(u3gfu_van_vrf, van);
