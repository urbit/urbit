  ...
  */
  ...
  _lily_hike_belt_l(u3_noun pac)
  {
    if ( (u3_nul == pac) ) {
      ...
      {
        if ( (1 != axis) &&
             (c3y == u3r_sing(2, u3gc_cap(axis))) )
        {
          u3_atom axis_tap = u3gc_mas(axis);
            ...
            u3_noun pac)
  {
    if ( (u3_nul == pac) ) {
      ...
      if ( u3_nul != zet ) {
        ...
        u3_noun hax = u3gc_peg(axe, 2);
        u3_noun moz = u3gc_peg(axe, 3);
        u3_noun zip = u3gf_hike(hax, tum);
        u3_noun dof = u3gf_hike(moz, gam);
        u3_noun fol = u3gf_cons(zip, dof);
