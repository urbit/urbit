    ...
    if ( (c3n == u3du(sut)) ) switch ( sut ) {
      ...
      case c3__cell: {
        if ( (c3n == u3r_trel(sut, 0, &p_sut, &q_sut)) ) {
          ...
          u3_atom tip = u3gc_cap(axe);
          u3_atom tap = u3gc_mas(axe);
      ...
      case c3__core: {
             ...
             (c3n == u3r_cell(rq_sut, &prq_sut, &qrq_sut)) )
        {
          ...
          u3_atom now = u3gc_cap(axe);
          u3_atom lat = u3gc_mas(axe);
      ...
      case c3__fork: p_sut = u3t(sut);
      {
        ...
        u3_noun ret = u3lf_fork(_peek_fork(van, yed, way, axe, gil));
...
*/
  ...
  u3_noun
  u3gfu_peek(u3_noun van,
             u3_noun sut,
             u3_noun way,
             u3_noun axe)
  {
    c3_m    fun_m = 144 + c3__peek + ((!!u3r_at(u3gfu_van_vet, van)) << 8);
