...
*/
                ...
                u3_noun leg)
  {
    if ( u3_nul == leg ) {
      ...
      return u3nc(u3gfu_play(van, u3h(i_leg), u3t(i_leg)),
  ...
  _rest_in_stil(u3_noun van,
                u3_noun gar)
  {
    u3_noun gun = u3gdi_gas(u3_nul, gar);
    u3_noun yed = u3gdi_tap(gun);
                ...
                u3_noun leg)
  {
    if ( u3_nul == leg ) {
      ...
      return c3o(u3gdi_has(fan, u3h(leg)),
  ...
  _cqfu_rest(u3_noun van,
             ...
             u3_noun leg)
  {
    u3_noun fan = u3r_at(u3gfu_van_fan, van);

    if ( c3y == _rest_hit_fan(fan, leg) ) {
      return u3m_error("rest-loop");
    }
    else {
      u3_noun naf = u3gdi_gas(fan, leg);
      u3_noun nav = u3i_molt(u3k(van), u3gfu_van_fan, u3k(naf), 0);
...
*/
  ...
  u3_noun
  u3gfu_rest(u3_noun van,
             u3_noun sut,
             u3_noun leg)
  {
    c3_m    fun_m = 144 + c3__rest + ((!!u3r_at(u3gfu_van_vet, van)) << 8);
