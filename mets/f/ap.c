...
#   define _ap_jet_hack  2
    ...
    */
    ...
    _ap_bunt(u3_noun van,
             u3_noun gen)
    {
      u3_noun pro = u3gfl_bunt(van, gen);
...
***/
  ...
  {    u3_noun tul = u3nc(u3nc(u3nc(c3__axil, c3__noun),
                               u3k(q_gen)),
                          u3_nul);
    u3_noun zal = u3gb_weld(r_gen, tul);
    ...
    u3gfp_rake(u3_noun gen)
    {
      ...
      if ( c3y == u3ud(gen) ) {
        ...
        case c3__zpcb: {
          ...
          else return u3gfp_rake(q_gen);
        }
      }
    }
    u3_noun
    u3yfp_rake(u3_noun cor)
    {
      u3_noun gen;
      ...
      if ( c3y == u3du(u3h(gen)) ) {
        ...
        case c3__tsgr: u3x_cell(u3t(gen), &p_gen, &q_gen);
        {
          if ( (c3n == u3du(p_gen)) || (u3_nul != u3h(p_gen)) ) {
            ...
            u3_noun pyr = u3gfp_hack(ter, q_gen);
