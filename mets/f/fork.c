...
*/
            ...
            u3_noun bur)
  {
    ...
    else return u3lf_fork(u3nt(u3k(hoz), u3k(bur), u3_nul));
  }

  u3_noun
  u3gf_fork(u3_noun yed)
  {
    u3_noun lez = u3_nul;
    ...
    while ( u3_nul != yed ) {
      ...
      if ( c3__void != i_yed ) {
        if ( (c3y == u3du(i_yed)) && (c3__fork == u3h(i_yed)) ) {
          lez = u3ldi_uni(lez, u3k(u3t(i_yed)));
        } 
        else {
          lez = u3ldi_put(lez, u3k(i_yed));
        }
      }
