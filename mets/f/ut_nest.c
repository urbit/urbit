...
*/
  ...
  */
        ...
        if ( (c3n == u3du(qqn_dab)) || (c3n == u3du(qqn_hem)) ) {
          ...
          case c3__ash: {
            if ( c3__ash != u3h(qqn_hem) ) {
              ...
              u3_noun vis = u3gfu_play(van, sut, qqqn_dab);
              u3_noun lon = u3gfu_play(van, ref, qqqn_hem);
             ...
             u3_noun gil)
  {
                        ...
                        (van, qq_ref, tel, p_ref, u3_nul, u3_nul, gil)) )
    {
           ...
           (c3__gold != pq_ref) ) 
      {
        ...
        if ( (c3y == u3gdi_has(gil, hud)) ) {
          u3z(hud);

          return c3y;
        }
        else {
          u3_noun zoc = u3gdi_put(gil, hud);
          ...
          if ( c3n == ret ) {
            ...
            switch ( pq_sut ) {
              ...
              case c3__iron: {
                u3_noun s_sam = u3gfu_peek(van, qq_sut, c3__rite, 2);
                u3_noun r_sam = u3gfu_peek(van, qq_ref, c3__rite, 2);
              ...
              case c3__zinc: {
                u3_noun s_pal = u3gfu_peek(van, qq_sut, c3__read, 2);
                u3_noun r_pal = u3gfu_peek(van, qq_ref, c3__read, 2);
                u3_noun ret = _nest_dext
...
#if 0
      u3_noun dun = u3gfu_dunq(van, "need", sut);
      u3_noun niz = u3gfu_dunq(van, "have", ref);
             ...
             u3_noun gil)
  {
    ...
    {
      c3_m    fun_m = 144 + c3__nest + ((!!u3r_at(u3gfu_van_vet, van)) << 8);
             ...
             u3_noun gil)
  {
    ...
    if ( (c3n == u3du(ref)) ) {
      ...
      switch ( u3h(ref) ) {
        ...
        case c3__core: {
          u3_noun gam = u3gfu_repo(van, ref);
