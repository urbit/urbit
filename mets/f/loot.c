           ...
           u3_atom axe)
  {
    if ( u3_nul == dom ) {
      ...
      if ( c3n == u3du(n_dom) ) {
        ...
        u3_noun yep = u3gf_look(cog, qqn_dom);
        ...
        if ( (u3_nul == l_dom) && (u3_nul == r_dom) ) {
          if ( u3_nul == yep ) {
            ...
            pro = u3nt(u3_nul, u3gc_peg(axe, u3h(u_yep)), u3k(u3t(u_yep)));
            u3z(yep);
            return pro;
          }
        }
          ...
          if ( u3_nul == yep ) {
            ...
            u3_noun u_yep = u3t(yep);
            u3_noun nax   = u3gc_peg(axe, 2);
            u3_noun pro;

            pro = u3nt(u3_nul, u3gc_peg(nax, u3h(u_yep)), u3k(u3t(u_yep)));
            u3z(nax);
            u3z(yep);
            return pro;
          }
...
*/
  u3_noun
  u3gf_loot(u3_noun cog,
            u3_noun dom)
  {
    return _loot_in(cog, dom, 1);
  }
  u3_noun
  u3yf_loot(u3_noun cor)
  {
    u3_noun cog, dom;
