...
++  rut                                                 ::  +turn into list
  ...
  (turn (rip a b) c)
::
++  rut-b                                                 ::  +turn into list
  |*  out=mold
  ~/  %rut
  |=  [a=bite b=@ c=$-(@ out)]
  ((turn-b @ out) (rip a b) c)
::
++  sew                                                 ::  stitch into
  ~/  %sew
...
++  shan                                                ::  sha-1 (deprecated)
  ...
  =+  ^=  wox
      =+  dux=(cut 9 [i 1] ful)
      =+  wox=(rep 5 ((turn-b @ @) (rip 5 dux) net))
      =+  j=16
      |-  ^-  @
      ?:  =(80 j)
        wox
...
++  cass                                                ::  lowercase
  |=  vib=tape
  ^-  tape
  ((turn-b _-.vib _-.vib) vib |=(a=@ ?.(&((gte a 'A') (lte a 'Z')) a (add 32 a))))
::
++  cuss                                                ::  uppercase
  |=  vib=tape
  ^-  tape
  ((turn-b @tD @tD) vib |=(a=@ ?.(&((gte a 'a') (lte a 'z')) a (sub a 32))))
::
  ...
  |^  ^-  tank
      ...
      ::
        ...
        :+  %rose
          [['/' ~] ['/' ~] ~]
        =+  yol=((list @ta) c.vem)
        ((turn-b @ta tank) yol |=(a=@ta [%leaf (trip a)]))
      ::
          [s=%l c=*]        (shol c.vem)
          [s=%o c=*]
        %=    $
...
++  smyt                                                ::  pretty print path
  |=  bon=path  ^-  tank
  :+  %rose  [['/' ~] ['/' ~] ~]
  ((turn-b _-.bon tank) bon |=(a=@ [%leaf (trip a)]))
::
...
++  jock
  ...
  ::
      %many
    [%cltr ((turn-b coin hoon) p.lot |=(a=coin ^$(lot a)))]
  ==
::
++  look
  ~/  %look
...
++  ah                                                  ::  tiki engine
  ...
  ++  wthp  |=  opt=(list (pair spec hoon))
            %+  gray  %wthp
            :-  puce
            %+  (turn-b ,[spec hoon] ,[spec hoon])
              opt
            |=([a=spec b=hoon] [a (blue b)])
...
++  ax
  ...
  ++  unfold
    ...
    ^-  hoon
    [%cncl fun ((turn-b spec hoon) arg |=(spec ktcl/+<))]
  ::
  ++  unreel
  ...
  ++  pieces
    ...
    |=  =(list term)
    ^-  (^list wing)
    ((turn-b term wing) list |=(=term `wing`[term ~]))
  ::
  ++  spore
...
::::
  ...
  ++  open
    ...
    ::
      ...
      :+  %cnts
        (weld p.gen `wing`[[%& 2] ~])
      %+  (turn-b ,[wing hoon] ,[wing hoon])
        r.gen
      |=([p=wing q=hoon] [p [%tsgr [%$ 3] q]])
    ::
    ...
    ::
      ...
      |^  :-  :+  (open-mane n.g.p.gen)
                %clsg
              ((turn-b ,[mane (list beer:hoot)] hoon) a.g.p.gen open-mart)
          [%mcts c.p.gen]
      ::
      ++  open-mane
        |=  a=mane:hoot
...
++  ut
  ...
  ++  fond
    ...
    ::
      ...
      =.  sut
        ...
        ?-  -.lap
          %&  p.lap
          %|  (fork ((turn-b ,[type *] type) ~(tap in q.lap) (head-b type)))
        ==
      =>  :_  +
          :*  axe=`axis`1
              lon=p.p.mor
      ...
      |%  ++  here  ?:  =(0 p.heg)
          ...
          ++  $
            ...
            ::
                [%fork *]
              =+  wiz=((turn-b type pony) ~(tap in p.sut) |=(a=type ^$(sut a)))
              ?~  wiz  ~
              |-  ^-  pony
              ?~  t.wiz  i.wiz
  ...
  ++  peek
    ...
    ::
        [%fork *]
      (fork ((turn-b type type) ~(tap in p.sut) |=(type ^$(sut +<))))
    ::
        [%hold *]
      ?:  (~(has in gil) sut)
        %void
  ...
  ++  redo                                              ::  refurbish faces
    ...
    ++  dext                                            ::  subject traverse
      ...
      ::
        ...
        ::
        (fork ((turn-b type type) ~(tap in p.sut) |=(type dext(sut +<))))
      ::
          [%hold *]
        ::  reduce to hard
        ::
  ...
  ++  rest
    ...
    %~  tap  in
    %-  ~(gas in *(set type))
    ((turn-b ,[type hoon] type) leg |=([p=type q=hoon] (play(sut p) q)))
  ::
  ++  take
    ...
    ?~  i.vit
      ...
      ?+  sut      ^$(vit t.vit)
        ...
        [%hint *]  (hint p.sut ^$(sut q.sut))
        [%fork *]  %-  fork
                   ((turn-b type type) ~(tap in p.sut) |=(type ^$(sut +<)))
        [%hold *]  $(sut repo)
      ==
    =+  vil=*(set type)
    |-  ^-  type
    ...
    ?-  sut
      ...
      [%face *]  (face p.sut $(sut q.sut))
      [%fork *]  (fork ((turn-b type type) ~(tap in p.sut) |=(type ^$(sut +<))))
      [%hint *]  (hint p.sut $(sut q.sut))
      [%hold *]  ?:  (~(has in vil) sut)
                   %void
...
++  sloe                                                ::  get arms in core
  ...
  ?+    typ  ~
      ...
      [%core *]
    %-  zing
    %+  (turn-b ,[* tome] (list term))  ~(tap by q.r.q.typ)
    |=  [* b=tome]
    %+  (turn-b ,[term *] term)  ~(tap by q.b)
    |=  [a=term *]
    a
  ==
::
...
++  vast                                                ::  main parsing core
  ...
  ++  gasp  ;~  pose                                    ::  parse =path= etc.
              ...
              ;~  plug
                (cook |=(a=(list) ((turn-b * ,~) a |=(b=* ~))) (star tis))
                (cook |=(a=hoon [[~ a] ~]) hasp)
                (cook |=(a=(list) ((turn-b * ,~) a |=(b=* ~))) (star tis))
              ==
              (cook |=(a=(list) ((turn-b * ,~) a |=(b=* ~))) (plus tis))
            ==
  ++  glam  ~+((glue ace))
  ...
  ++  docs
    ...
    ++  beer
      ...
      %+  (turn-b ,[[term cord] (list sect)] ,[term cord (list sect)])
        def
      |=([[a=term b=cord] c=(list sect)] [a [b c]])
    ::
    ::
    ++  body
      ;~  pose
  ...
  ++  poof                                              ::  path -> (list hoon)
    |=  pax=path
    ^-((list hoon) ((turn-b knot hoon) pax |=(a=@ta [%sand %ta a])))
  ::
  ::  tyke is =foo== as ~[~ `foo ~ ~]
  ...
  ++  sail                                              ::  xml template
    ...
    ++  join-tops
      ...
      (zing ((turn-b _-.a (list tuna:hoot)) a drop-top))
    ::
    ::+|
    ::
