...
++  test-zeros  ^-  tang
  ;:  weld
    ...
    %+  expect-eq
      !>  (zeros:lvs 3)
      !>  `@lvs`0x3.0000.0000.0000.0000.0000.0000
    %+  expect-eq
      !>  (zeros:lvs 3)
      !>  (make:lvs ~[.0 .0 .0])
    %+  expect-eq
      !>  (zeros:lvs 5)
      !>  `@lvs`0x5.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000
    %+  expect-eq
      !>  (zeros:lvs 5)
      !>  (make:lvs `(list @rs)`(reap 5 .0))
    %+  expect-eq
      !>  (zeros:lvs 16)
      !>  `@lvs`0x10.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000
    %+  expect-eq
      !>  (zeros:lvs 16)
...
++  test-ones  ^-  tang
  ;:  weld
    ...
    %+  expect-eq
      !>  (ones:lvs 3)
      !>  `@lvs`0x3.3ff0.0000.3ff0.0000.3ff0.0000
    %+  expect-eq
      !>  (ones:lvs 3)
      !>  (make:lvs ~[.1 .1 .1])
    %+  expect-eq
      !>  (ones:lvs 5)
      !>  `@lvs`0x5.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000
    %+  expect-eq
      !>  (ones:lvs 5)
      !>  (make:lvs `(list @rs)`(reap 5 .1))
    %+  expect-eq
      !>  (ones:lvs 16)
      !>  `@lvs`0x10.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000
    %+  expect-eq
      !>  (ones:lvs 16)
...
++  test-make  ^-  tang
  ;:  weld
    ...
    %+  expect-eq
      ...
      !>  (make:lvs `(list @rs)`(reap 16 .0))
    %+  expect-eq
      !>  `@lvs`0x2.4000.0000.3f80.0000
      !>  (make:lvs ~[.1 .2])
    %+  expect-eq
      !>  `@lvs`0x3.4040.0000.4000.0000.3f80.0000
      !>  (make:lvs ~[.1 .2 .3])
    %+  expect-eq
      !>  `@lvs`0x8.4080.0000.4040.0000.4000.0000.3f80.0000.0000.0000.bf80.0000.c000.0000.c040.0000
...
++  test-unmake  ^-  tang
  ;:  weld
    ...
    %+  expect-eq
      !>  `(list @rs)`~[.0 .0 .0]
      !>  (unmake:lvs `@lvs`0x3.0000.0000.0000.0000.0000.0000)
    %+  expect-eq
      !>  `(list @rs)`(reap 5 .0)
      !>  (unmake:lvs `@lvs`0x5.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000)
    %+  expect-eq
      !>  `(list @rs)`(reap 16 .0)
      !>  (unmake:lvs `@lvs`0x10.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000.0000)
    %+  expect-eq
      !>  `(list @rs)`~[.1]
      !>  (unmake:lvs `@lvs`0x1.3ff0.0000)
    %+  expect-eq
      !>  `(list @rs)`~[.1 .1 .1]
      !>  (unmake:lvs `@lvs`0x3.3ff0.0000.3ff0.0000.3ff0.0000)
    %+  expect-eq
      !>  `(list @rs)`(reap 5 .1)
      !>  (unmake:lvs `@lvs`0x5.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000)
    %+  expect-eq
      !>  `(list @rs)`(reap 16 .0)
      !>  (unmake:lvs `@lvs`0x10.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000)
    %+  expect-eq
      !>  `(list @rs)`~[.1 .2]
      !>  (unmake:lvs `@lvs`0x2.4000.0000.3f80.0000)
    %+  expect-eq
      !>  `(list @rs)`~[.1 .2 .3]
      !>  (unmake:lvs `@lvs`0x3.4040.0000.4000.0000.3f80.0000)
    %+  expect-eq
      !>  `(list @rs)`~[.-3 .-2 .-1 .0 .1 .2 .3 .4]
      !>  (unmake:lvs `@lvs`0x8.4080.0000.4040.0000.4000.0000.3f80.0000.0000.0000.bf80.0000.c000.0000.c040.0000)
  ==
