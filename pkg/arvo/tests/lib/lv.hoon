...
++  test-ones  ^-  tang
  ;:  weld
    ...
    %+  expect-eq
      !>  (ones:lvs 3)
      !>  `@lvs`0x1.3ff0.0000.3ff0.0000.3ff0.0000
    %+  expect-eq
      !>  (ones:lvs 3)
      !>  (make:lvs ~[.1 .1 .1])
    %+  expect-eq
      !>  (ones:lvs 5)
      !>  `@lvs`0x1.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000
    %+  expect-eq
      !>  (ones:lvs 5)
      !>  (make:lvs `(list @rs)`(reap 5 .1))
    %+  expect-eq
      !>  (ones:lvs 16)
      !>  `@lvs`0x1.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000
    %+  expect-eq
      !>  (ones:lvs 16)
...
++  test-unmake  ^-  tang
  ;:  weld
    ...
    %+  expect-eq
      !>  `(list @rs)`~[.1 .1 .1]
      !>  (unmake:lvs `@lvs`0x1.3ff0.0000.3ff0.0000.3ff0.0000)
    %+  expect-eq
      !>  `(list @rs)`(reap 5 .1)
      !>  (unmake:lvs `@lvs`0x1.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000)
    %+  expect-eq
      !>  `(list @rs)`(reap 16 .0)
      !>  (unmake:lvs `@lvs`0x1.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000.3ff0.0000)
    %+  expect-eq
      !>  `(list @rs)`~[.1 .2]
