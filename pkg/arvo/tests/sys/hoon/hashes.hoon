...
::
  ;:  weld
    ...
    %+  expect-eq
      ...
      !>  `@ux`(sha-1:sha 'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq')
    ::
    %+  expect-eq
      !>  0xa49b.2446.a02c.645b.f419.f995.b670.9125.3a04.a259
      !>  `@ux`(sha-1:sha 'abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu')
    ::
  ==
::
++  test-sha-1l
...
::
  ;:  weld
    ...
    %+  expect-eq
      ...
      !>  `@ux`(sha-1l:sha [4 0x549e.959e])
    ::  Long Message
    ::
    %+  expect-eq
      !>  0xd8fd.6a91.ef3b.6ced.05b9.8358.a991.07c1.fac8.c807
      !>  `@ux`(sha-1l:sha [163 0x7c.9c67.323a.1df1.adbf.e5ce.b415.eaef.0155.ece2.820f.4d50.c1ec.22cb.a492.8ac6.56c8.3fe5.85db.6a78.ce40.bc42.757a.ba7e.5a3f.5824.28d6.ca68.d0c3.9783.36a6.efb7.2961.3e8d.9979.0162.04bf.d921.322f.dd52.2218.3554.447d.e5e6.e9bb.e6ed.f76d.7b71.e18d.c2e8.d6dc.89b7.3983.64f6.52fa.fc73.4329.aafa.3dcd.45d4.f31e.388e.4faf.d7fc.6495.f37c.a5cb.ab7f.54d5.8646.3da4.bfea.a3ba.e09f.7b8e.9239.d832.b4f0.a733.aa60.9cc1.f8d4])
    ::  Leading-zero byte
    ::
    %+  expect-eq
      !>  0x9f4e.66b6.ceea.40dc.f4b9.166c.28f1.c884.7414.1da9
      !>  `@ux`(sha-1l:sha [12 0x938.f2e2.ebb6.4f8a.f8bb.fc91])
    ::
  ==
::
++  test-shay
...
::
  ;:  weld
    ...
    %+  expect-eq
      ...
      !>  `@ux`(sha-256:sha 'abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq')
    ::
  ==
::
++  test-shad
...
::
  ;:  weld
    ...
    %+  expect-eq
      ...
      !>  `@ux`(sha-512:sha 'abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu')
    ::
  ==
::
++  test-shas
