            ...
            class Clock extends react_1 {
              ...
              componentDidMount() {
                ...
                navigator.geolocation.getCurrentPosition((res) => {
                  ...
                  const suncalc$1 = suncalc.getTimes(new Date(), lat, lon);

                  const convertedSunCalc = {
                    sunset: convert(suncalc$1.sunset, this.referenceTime),
                    sunrise: convert(suncalc$1.sunrise, this.referenceTime),
                    sunsetStart: convert(suncalc$1.sunsetStart, this.referenceTime),
                    sunriseEnd: convert(suncalc$1.sunriseEnd, this.referenceTime),
                    dusk: convert(suncalc$1.dusk, this.referenceTime),
                    dawn: convert(suncalc$1.dawn, this.referenceTime),
                    night: convert(suncalc$1.night, this.referenceTime),
                    nightEnd: convert(suncalc$1.nightEnd, this.referenceTime),
                    nauticalDawn: convert(suncalc$1.nauticalDawn, this.referenceTime),
