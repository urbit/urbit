      ...
      ++  pe
        ...
        ++  po
          =>  |%
              ...
              +$  poke-state
                $:  poke-sender-state
                    poke-receiver-state
                ==
              +$  client-gift  :: gifts emitted when sending requests
              ...
              +$  publisher-gift  :: gifts emitted when hearing requests
                ...
                ==
              +$  message-task
                $%  ::[%plea vane=@tas =path payload=*] ::  client vane remote request (e.g. %gall: %watch, %poke)
          ...
          ::  =?  po-core  ?=(^ unsent-messages.state)
            ...
            ::  %-  emil
            ::  :~  [%magic-send pact]
            ::      ::make-first-packet-timer
            ::  ==
          po-core
          ::  %_  po-core
          ::    unsent-messages.state  (~(put to unsent-messages.state) pact)
          ::  ==
          ::
          ++  po-hear-sign  !!
            ::  name=[p=ship q=path r=bloq s=num=@udF]
