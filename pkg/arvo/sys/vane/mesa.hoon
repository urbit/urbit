      ...
      ++  ma  :: XX use +abet
        ...
        ++  ma-response
          ...
          =^  moves  ax
            ...
            %.  [flow response/[seq +.load]]
            fo-take:(fo-abed:fo hen bone^dire %out pe-chan)
          (res-emil moves)
        ::
        ++  ma-poke-done
          ...
          =^  moves  ax
            ...
            ::
            (fo-take:(fo-abed:fo hen bone^dire %in pe-chan) %out done/error)
          (res-emil moves)
        ::
        :: +|  %internals
        ::
    ...
    ++  fo  ::  ++flow (fo)
      ...
      ++  fo-abed
        ...
        =.  state
          ...
          *fo-inbound
        fo-core(hen duct, side bone^dire, channel channel, peer-state peer-state)
      ::
