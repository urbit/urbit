...
++  mo
  ...
  ++  mo-apply
    ...
    ::
      ...
      =/  sky  (rof tick ~ /gall %cb [our desk case] /[mark.deal])
      ?-    sky
          ?(~ [~ ~])
    ...
    ::
      ...
      =/  yok  (~(got by yokes.state) dap)
      =/  =desk  q.beak:?>(?=(%live -.yok) yok)  ::TODO acceptable assertion?
      =/  sky  (rof tick ~ /gall %cc [our desk case] mars-path)
      ?-    sky
          ?(~ [~ ~])
  ...
  ++  ap
    ...
    ++  ap-from-internal
      ...
      ::
        ...
        =/  mars-path  /[a.mars]/[b.mars]
        =/  sky  (rof tick ~ /gall %cc bek mars-path)
        ?-    sky
            ?(~ [~ ~])
    ...
    ++  ap-peek
      ...
      =/  tub=(unit tube:clay)
        ...
        =/  tuc=(unit (unit cage))
          (rof tick ~ /gall %cc [our q.beak.yoke da+now] /[have]/[want])
        ?.  ?=([~ ~ *] tuc)  ~
        `!<(tube:clay q.u.u.tuc)
      ?~  tub
    ...
    ++  ap-specific-take
      ...
      =^  =sign:agent  ap-core
        ...
        ?:  ?=(%spider agent-name)
          ...
          ap-core
        =/  sky  (rof tick ~ /gall %cb [our q.beak.yoke case] /[mark.unto])
        ?.  ?=([~ ~ *] sky)
    ...
    ++  ap-rake
      ...
      ++  scry-peer-state
        ...
        =/  sky  (rof tick [~ ~] /gall %ax [our %$ da+now] /peers/(scot %p her))
        ?:  |(?=(~ sky) ?=(~ u.sky))
          ~
    ...
    ++  ap-mule
      ...
      =/  res  (mock [run %9 2 %0 1] (look rof tick ~ /gall/[agent-name]))
      ?-  -.res
