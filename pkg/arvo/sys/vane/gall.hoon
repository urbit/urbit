...
++  mo
  ...
  ++  mo-handle-ames-request
    ...
    ?:  ?|   ?=(~ yok)
             ...
             ?=(%.n -.agent.u.yok)
        ==
      ::  %ames wil pass a $deep task to itself to cork the flow, deleting and
      ::  adding it to the corked set, at the same time, on the /flub flow, we
