...
class extends HTMLElement {
  ...
  get currentFeatherRules() {
    ...
    let rules = [
      { variable: 'light-b4', unit: ''},
      { variable: 'light-b3', unit: ''},
      { variable: 'light-b2', unit: ''},
      { variable: 'light-b1', unit: ''},
      { variable: 'light-b0', unit: ''},
      { variable: 'light-b-1', unit: ''},
      { variable: 'light-b-2', unit: ''},
      { variable: 'light-b-3', unit: ''},
      { variable: 'light-f4', unit: ''},
      { variable: 'light-f3', unit: ''},
      { variable: 'light-f2', unit: ''},
      { variable: 'light-f1', unit: ''},
      { variable: 'light-f0', unit: ''},
      { variable: 'light-f-1', unit: ''},
      { variable: 'light-f-2', unit: ''},
      { variable: 'light-f-3', unit: ''},
      { variable: 'dark-b4', unit: ''},
      { variable: 'dark-b3', unit: ''},
      { variable: 'dark-b2', unit: ''},
      { variable: 'dark-b1', unit: ''},
      { variable: 'dark-b0', unit: ''},
      { variable: 'dark-b-1', unit: ''},
      { variable: 'dark-b-2', unit: ''},
      { variable: 'dark-b-3', unit: ''},
      { variable: 'dark-f4', unit: ''},
      { variable: 'dark-f3', unit: ''},
      { variable: 'dark-f2', unit: ''},
      { variable: 'dark-f1', unit: ''},
      { variable: 'dark-f0', unit: ''},
      { variable: 'dark-f-1', unit: ''},
      { variable: 'dark-f-2', unit: ''},
      { variable: 'dark-f-3', unit: ''},
      { variable: 'font', unit: ''},
