...
#   define u3qdb_wyt u3qdi_wyt
    ...
    u3_noun u3qdu_lbal(u3_noun);
    u3_noun u3qdu_rbal(u3_noun);
    u3_noun u3qdu_llbal(u3_noun);
    u3_noun u3qdu_rrbal(u3_noun);
    u3_noun u3qdu_lrbal(u3_noun);
    u3_noun u3qdu_rlbal(u3_noun);
    u3_noun u3qdu_llsin(u3_noun);
    u3_noun u3qdu_rrsin(u3_noun);
    u3_noun u3qdu_lrsin(u3_noun);
    u3_noun u3qdu_rlsin(u3_noun);
    u3_noun u3qdu_lldub(u3_noun);
    u3_noun u3qdu_rrdub(u3_noun);
