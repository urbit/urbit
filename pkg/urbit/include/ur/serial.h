...
uint64_t
ur_jam_with(ur_jam_t* j, ur_nref ref, uint64_t* len, uint8_t** byt);
void
...
ur_cue_res_e
ur_cue_with(ur_cue_t* c, uint64_t len, const uint8_t* byt, ur_nref* out);
...
ur_bool_t
ur_cue_test_with(ur_cue_test_t* t, uint64_t len, const uint8_t* byt);
