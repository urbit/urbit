 ...
 */
#define u3x_peg(a_w, b_w) ((a_w << u3x_dep(b_w)) | (b_w & ~(1 << u3x_dep(b_w))))

/* u3x_atom(): atom or exit.
 */
#define u3x_atom(a)       ((c3y == u3a_is_cell(a)) ? u3m_bail(c3__exit) : a)
...
*/
void
u3x_cell(u3_noun a, u3_noun* b, u3_noun* c);
...
*/
void
u3x_trel(u3_noun a, u3_noun* b, u3_noun* c, u3_noun* d);
...
*/
void
u3x_qual(u3_noun a, u3_noun* b, u3_noun* c, u3_noun* d, u3_noun* e);
...
*/
void
u3x_quil(u3_noun a, u3_noun* b, u3_noun* c, u3_noun* d, u3_noun* e, u3_noun* f);
