...
typedef struct _u3_utty {
  ...
  c3_o (*wsz_f)(struct _u3_utty* uty_u,
                c3_l*            col_l,
 ...
 */
u3_ovum*
u3_ovum_init(c3_w mil_w, u3_noun tar, u3_noun wir, u3_noun cad);
 ...
 */
c3_o
u3_disk_read_meta(u3_disk* log_u, c3_d* who_d, c3_o* fak_o, c3_w* lif_w);

/* u3_disk_save_meta(): save metadata.
 */
c3_o
u3_disk_save_meta(u3_disk* log_u, c3_d who_d[2], c3_o fak_o, c3_w lif_w);
 ...
 */
u3_lane u3_ames_decode_lane(u3_noun);

/* u3_ames_encode_lane(): encode lane as noun
 */
u3_noun u3_ames_encode_lane(u3_lane);
