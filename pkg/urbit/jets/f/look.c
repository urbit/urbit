 ...
 */
static u3_noun
_look_in(u3_noun cog, u3_noun dab, u3_atom axe)
{
  if ( u3_nul == dab ) {
    return u3_nul;
  }
    ...
    if ( c3n == u3du(n_dab) ) {
      ...
      if ( (u3_nul == l_dab) && (u3_nul == r_dab) ) {
        if ( (c3y == u3du(qn_dab)) && (c3y == u3r_sing(cog, pn_dab)) ) {
          return u3nt(u3_nul, u3k(axe), u3k(qn_dab));
        }
        else {
          return u3_nul;
        }
        ...
        if ( (c3y == u3du(qn_dab)) && (c3y == u3r_sing(cog, pn_dab)) ) {
          return u3nt(u3_nul, u3qc_peg(axe, 2), u3k(qn_dab));
        }
        else {
 ...
 */
u3_noun
u3qf_look(u3_noun cog, u3_noun dab)
{
