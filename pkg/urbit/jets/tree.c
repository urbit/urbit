...
static c3_c*    _140_hex_mimes_base16_en_ha[]
  = {"669807766b6802719769fcbfe149d77fb352fcf0922afaf35dc4ab8c201d84e5", 0};

static u3j_harm _140_hex_mimes_base16_de_a[] = {{".2", u3we_de_base16}, {}};
static c3_c*    _140_hex_mimes_base16_de_ha[]
  = {"f1e04d0f452f2783e17b3bd5bbbcf95a651624fe7a2aca28dd9a7feae1319734", 0};
...
static c3_c* _140_hex_aes_ecba_ha[]
  = {"693409d27b777f73ce92cebd38e9ebceebe1e9c27ad8c9de9afc091e31bd7d9f", 0};
...
static c3_c* _140_hex_aes_ecbb_ha[]
  = {"7255c39f10e068007d0d64dd40e4f6e83492ed2e3222919440be0d28fd42a5e3", 0};
...
static c3_c* _140_hex_aes_ecbc_ha[]
  = {"65da73b8de06a6660ca2d36be881b708362e1f8bc12c01290aed90fdb2977667", 0};
...
static c3_c* _140_hex_aes_cbca_ha[]
  = {"420d04c03b7816b656fe4e8d9fce04f7e6d51d3d274c6511e89cfdb43ebf107e", 0};
...
static c3_c* _140_hex_aes_cbcb_ha[]
  = {"1b84daab497795f2afd7238a6a6090be68b78eb6051b0ffa076b2ed9fedeebe5", 0};
...
static c3_c* _140_hex_aes_cbcc_ha[]
  = {"3bab1a59c7673afeb659821d54754e8e5e281243e79624fdbe4d7f85cae192c5", 0};
...
static c3_c* _140_hex_aes_siva_ha[]
  = {"435c5c769d2522d71ab60332bb57440d69c6803d5ca9a5faae88c825cb55d72e", 0};
...
static c3_c* _140_hex_aes_sivb_ha[]
  = {"0683f3f9067c2a16f68805c778c404179dc5df9019bbbe0f8d680a99a69e61fc", 0};
...
static c3_c* _140_hex_aes_sivc_ha[]
  = {"23ef582f110d28aff82b0795305b02e5a718d667bcae97091c08bc26790e7176", 0};
...
static c3_c* _140_hex_coed__ed_scalarmult_base_ha[]
  = {"976fdb8251f9b767af689a0d2c41b88941921bf53777c1ceeb5297511021f9d8", 0};
...
static c3_c* _140_hex_coed__ed_add_scalarmult_scalarmult_base_ha[]
  = {"11819071c24a2d7b36daea6e16c78b2e05f9ca3e857cf4815ffe652ce677a61a", 0};
...
static c3_c* _140_hex_coed__ed_add_double_scalarmult_ha[]
  = {"0fab78a1e890e53cecade1c22b95813db77e066044e33417a0919695b6cde9ba", 0};
...
static c3_c* _140_hex_secp_secp256k1_ha[]
  = {"e7fc0971a970aba7ded43bd89e9c82623eb2f346c9c720c63b22f2a646927861", 0};
static u3j_core _140_hex_secp_secp256k1_d[]
  = {{"make",
      7,
      _140_hex_secp_secp256k1_make_a,
      0,
      _140_hex_secp_secp256k1_make_ha},
     {"sign",
      7,
      _140_hex_secp_secp256k1_sign_a,
      0,
      _140_hex_secp_secp256k1_sign_ha},
     {"reco",
      7,
      _140_hex_secp_secp256k1_reco_a,
      0,
      _140_hex_secp_secp256k1_reco_ha},
     {}};

static c3_c* _140_hex_secp_ha[]
  = {"9f5c23f0e7923b6cf1603388ba52401b6e43881be3560b3acfaab20b25071792", 0};
...
static c3_c*    _140_hex_blake2b_ha[]
  = {"c432216ca53b5ad2284259167952761bb1046e280268c4d3b9ca70a2024e1934", 0};
static u3j_core _140_hex_blake_d[]
  = {{"blake2b", 7, _140_hex_blake2b_a, 0, _140_hex_blake2b_ha}, {}};
static c3_c* _140_hex_blake_ha[]
  = {"ff30d99ffb3e13d8aa50b2b8461c8edfabf0e76de22312d16d1d6daaf3636b5f", 0};
...
static c3_c*    _140_hex_ripemd_160_ha[]
  = {"176684b29926a01f5c60fa584e4691b0cbdc9b93608dcbe7d0cf3585683fa42f", 0};
static u3j_core _140_hex_ripe_d[]
  = {{"ripemd160", 7, _140_hex_ripemd_160_a, 0, _140_hex_ripemd_160_ha}, {}};
static c3_c* _140_hex_ripe_ha[]
  = {"b0cb16bf206c0496bb480e5759ea1afa7dee1748b64e5243c23fddb09720ebd0", 0};
...
static c3_c* _140_hex_ha[]
  = {"7e393356dd7ac64eed5cd9f5cf0e320d401ca36a0a0ce0f954e7538824114844", 0};

/* layer five
 */
static u3j_harm _140_pen_cell_a[] = {{".2", u3wf_cell}, {}};
static c3_c*    _140_pen_cell_ha[]
  = {"411649e69ff5c5d4a2976b300d213b99af3de724cec0e95f48404b808fc4f428", 0};
static u3j_harm _140_pen_comb_a[] = {{".2", u3wf_comb}, {}};
static c3_c*    _140_pen_comb_ha[]
  = {"f9e37c3b3d5036c31af60f7047391594068638b54db7cf94bfea9dabbdffa547", 0};
static u3j_harm _140_pen_cons_a[] = {{".2", u3wf_cons}, {}};
static c3_c*    _140_pen_cons_ha[]
  = {"b698cc6bc49ea0473e344c784075e99a433b4c5738f90fc58ab17c3eaa44b2e9", 0};
static u3j_harm _140_pen_core_a[] = {{".2", u3wf_core}, {}};
static c3_c*    _140_pen_core_ha[]
  = {"1180e9371cf3465783ef192f9a7f580cd90533f5b52b77b456287f1d580a3535", 0};
static u3j_harm _140_pen_face_a[] = {{".2", u3wf_face}, {}};
static c3_c*    _140_pen_face_ha[]
  = {"a184c44d57f5c94b84a3258b05bf891f3c96a4a4bbff3a8934d11cad0efa81d8", 0};
static u3j_harm _140_pen_fitz_a[] = {{".2", u3wf_fitz}, {}};
static c3_c*    _140_pen_fitz_ha[]
  = {"469abe976ec15eeff9a87bce385f2c87c9bd89814ce2858aa9fee094beea1e5d", 0};
static u3j_harm _140_pen_flan_a[] = {{".2", u3wf_flan}, {}};
static c3_c*    _140_pen_flan_ha[]
  = {"cc00cb9373b0274af4e17d7acd77f65d8a2fa886e422c949c12d9d9e7cb3525b", 0};
static u3j_harm _140_pen_flip_a[] = {{".2", u3wf_flip}, {}};
static c3_c*    _140_pen_flip_ha[]
  = {"6e97fab9d039e715a30af5da93ef97389babfdcae7ef87655d278e77a1af0f0c", 0};
static u3j_harm _140_pen_flor_a[] = {{".2", u3wf_flor}, {}};
static c3_c*    _140_pen_flor_ha[]
  = {"ab5360aacf0c9a325727e90e1caea9c42f5d94ccc248c9e1f253b0922b4c4e63", 0};
static u3j_harm _140_pen_fork_a[] = {{".2", u3wf_fork}, {}};
static c3_c*    _140_pen_fork_ha[]
  = {"36f0ea0e2eb30328b8b83ed43a81c8c9a1f5b4c5a03fd68fd25701991a40b9dd", 0};
...
static c3_c* _140_pen__ut_nest_in_ha[]
  = {"68378dfa1d1fee0b1cd9593fb561234cec2ae9371a5ffa287c3d2ab9620e198c", 0};
...
static c3_c* _140_pen__ut_nest_ha[]
  = {"1e8de5d1225facc1158c92c2ea5e0dc84129cbb317fde3691e224b8c2550d950", 0};

static u3j_harm _140_pen__ut_rest_a[] = {{".2", u3wfu_rest}, {}};
static c3_c*    _140_pen__ut_rest_ha[]
  = {"b4a83073f4cb03898ef099fab5722a046122dc96a5332ffc82f988df6c186e74", 0};
...
static c3_c* _140_pen__ut_ha[]
  = {"50c79204c82a3ba8f01e085a2e27e7716e5c7ab1929f94423ef1da92cf5ac631", 0};
...
static c3_c* _140_pen_ha[]
  = {"e6c9e2362bdf2d1f9a2837a0efa154c0b8b9d51aea03a86b5aece573ff423cb1", 0};
...
static c3_c* _140_qua_ha[]
  = {"db9b4b21c0a8a8324105cbccc1421ef2a715ef0562c280b943fe1d96651cd9cc", 0};
...
static c3_c*    _140_tri__cofl__drg_ha[]
  = {"6063adb8cac639f7b20d5e7700c8108266be04f99cce4434f906240b424bf36d", 0};
static u3j_harm _140_tri__cofl__lug_a[] = {{".2", u3wef_lug}, {}};
static c3_c*    _140_tri__cofl__lug_ha[]
  = {"f146a84731447e5c4b1e7b6e9331b33d1babed09bb0618e134c9535062154a87", 0};
...
static c3_c* _140_tri_ha[]
  = {"e7339eb317038f64555717c5624e4571fe9654d471c1a78454129afdbcad9b53", 0};
...
static c3_c*    _140_two__by_run_ha[]
  = {"adea01e9036e0b40e4969814d4eed935d7d69a52e4a55de5520df2fa5204d8e7", 0};
...
static c3_c*    _140_two__by_uni_ha[]
  = {"f18bc4dac19abe14a6f56afc15d838b7394d48969156f4b37c3c84edd5d46752", 0};
static u3j_harm _140_two__by_urn_a[] = {{".2", u3wdb_urn, c3y}, {}};
static c3_c*    _140_two__by_urn_ha[]
  = {"a409cf78e7f1c2ce8440115730f74367839b658cde2d6a1daa8af067b790eb83", 0};
...
static c3_c* _140_two__by_ha[]
  = {"9c70e973de46335405a7ff932d4742743f54db579f2584758ef2b02afd4fbfe8", 0};

static u3j_harm _140_two_cue_a[] = {{".2", u3we_cue}, {}};
static c3_c*    _140_two_cue_ha[]
  = {"a52b584c5a92fc653e47f50c3389caf3427e13d20ddb8bd701a2d7bca12cb742", 0};
static u3j_harm _140_two_jam_a[] = {{".2", u3we_jam}, {}};
static c3_c*    _140_two_jam_ha[]
  = {"61f86be74cb1fd5a1d7f531cc9588f8f34a972be8de487c93d25c8e026592ed2", 0};
static u3j_harm _140_two_mat_a[] = {{".2", u3we_mat}, {}};
static c3_c*    _140_two_mat_ha[]
  = {"b5cd9fd1eded54fcb9bfd06af3c34460c1aa4cfc46f1ee9bd3f6476aa8fbb8c8", 0};
static u3j_harm _140_two_rub_a[] = {{".2", u3we_rub}, {}};
static c3_c*    _140_two_rub_ha[]
  = {"87fcf40fb6fce8c3cb778373670d0682785ae650f785531db8ff69d431bc14c6", 0};
...
static c3_c* _140_two_ha[]
  = {"f693e1f5ff57ec741fe28a48a18252b3e12dead2bfe3bcd4ea8e904a36905c0b", 0};

/* layer one
 */
static u3j_harm _140_one_add_a[] = {{".2", u3wa_add, c3y}, {}};
static c3_c*    _140_one_add_ha[]
  = {"46407e27fe5d7c20b3ba25c02657c227b37217ddab8501b2d3b70b818aca7a44", 0};
static u3j_harm _140_one_dec_a[] = {{".2", u3wa_dec, c3y}, {}};
static c3_c*    _140_one_dec_ha[]
  = {"6345d28d34c62c4b4f9da98828574bc9060ff0869789968d9045d90faeb3580c", 0};
static u3j_harm _140_one_div_a[] = {{".2", u3wa_div, c3y}, {}};
static c3_c*    _140_one_div_ha[]
  = {"e3292e76feb274b9314e7693827de11e96677629c556b3a6c72cc15ebad45113", 0};
static u3j_harm _140_one_dvr_a[] = {{".2", u3wc_dvr, c3y}, {}};
static c3_c*    _140_one_dvr_ha[]
  = {"fc259f46d770f82767163544f3662dfd45b1484a7bcffad396c7420651f092a4", 0};
static u3j_harm _140_one_gte_a[] = {{".2", u3wa_gte, c3y}, {}};
static c3_c*    _140_one_gte_ha[]
  = {"f3ff2c0fc1f386226183e8834cff87420a1206583f8710e1e75f0e34ed8df5fe", 0};
static u3j_harm _140_one_gth_a[] = {{".2", u3wa_gth, c3y}, {}};
static c3_c*    _140_one_gth_ha[]
  = {"62692d64c8166c7d48bb2a00713064846da9629a1dd2d924c3b15cfd18a5912a", 0};
static u3j_harm _140_one_lte_a[] = {{".2", u3wa_lte, c3y}, {}};
static c3_c*    _140_one_lte_ha[]
  = {"6ca61752aa27b453f28f20e12f652610d45695c3bd965190d5b4fa8b9daa518c", 0};
static u3j_harm _140_one_lth_a[] = {{".2", u3wa_lth, c3y}, {}};
static c3_c*    _140_one_lth_ha[]
  = {"39260325faffbbf5bd88c4abb3efb09c5a7e1deb81a2126498d6c0f49474955e", 0};
static u3j_harm _140_one_mod_a[] = {{".2", u3wa_mod, c3y}, {}};
static c3_c*    _140_one_mod_ha[]
  = {"374d2f3cd0ece33f680bd7103b99891d7dae03590f9eb9faac03a4a501f17038", 0};
static u3j_harm _140_one_mul_a[] = {{".2", u3wa_mul, c3y}, {}};
static c3_c*    _140_one_mul_ha[]
  = {"51e45dbea29cf65a5c26ead095a20eb12ba078840652c88b9c1997820e670bc6", 0};
static u3j_harm _140_one_sub_a[] = {{".2", u3wa_sub, c3y}, {}};
static c3_c*    _140_one_sub_ha[]
  = {"016695719ffe93c177e8a03afa5d29fc428ff596bb8962ace50f7706cd6e53a6", 0};

static u3j_harm _140_one_cap_a[] = {{".2", u3wc_cap, c3y}, {}};
static c3_c*    _140_one_cap_ha[]
  = {"407e764ee978c712b81c9c3452932e0f7d33faeda36dfe99aaf81d543db16254", 0};
static u3j_harm _140_one_peg_a[] = {{".2", u3wc_peg, c3y}, {}};
static c3_c*    _140_one_peg_ha[]
  = {"8b608d2d2e2eccec3e2fc8cd2d92fd69504c72b26581bb9cbfa4ff51f997251f", 0};
static u3j_harm _140_one_mas_a[] = {{".2", u3wc_mas, c3y}, {}};
static c3_c*    _140_one_mas_ha[]
  = {"1439dcd809f0819b09fb5fe7e83bc1292ca6fd33b5819d78e706d402c053b02a", 0};

static u3j_core _140_one_d[] = {{"two", 3, 0, _140_two_d, _140_two_ha},
...
static c3_c*    _140_one_ha[]
  = {"2501f8dbe62384d144ab0f805501ed66325bd77a733eca0c80d1da673e4b16fb", 0};

u3j_core     _k140_d[] = {{"one", 3, 0, _140_one_d, _140_one_ha}, {}};
static c3_c* _k140_ha[]
  = {"9b82a903093c077afb3f0b9d4e95e1a9c9789d1ca605b57bbacf79857e3d5c52", 0};
