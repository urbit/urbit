...
static u3_noun
_slip(u3_noun weq, u3_noun naz)
{
  u3_noun p_naz, q_naz;

  u3x_cell(naz, &p_naz, &q_naz);
  if ( 10 == weq ) {
    return u3nc(u3x_good(u3i_vint(u3k(p_naz))), 1);
  }
  else {
    return u3nc(u3k(p_naz), u3x_good(u3i_vint(u3k(q_naz))));
  }
}
...
_last(u3_noun zyc, u3_noun naz)
{
  ...
  if ( !_(u3a_is_cat(p_zyc)) || !_(u3a_is_cat(q_zyc)) || !_(u3a_is_cat(p_naz))
       || !_(u3a_is_cat(q_naz)) )
  {
...
_next(u3_noun tub)
{
  ...
  if ( c3n == u3du(q_tub) ) {
    ...
    return u3nc(zac, u3nq(u3_nul, u3k(iq_tub), u3k(zac), u3k(tq_tub)));
  }
}
 ...
 */
static u3_noun
_cqe_bend_fun(u3_noun raq, u3_noun vex, u3_noun sab)
{
  u3_noun p_vex, q_vex;
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    if ( c3n == u3du(q_yit) ) {
      ...
      vux = u3x_good(u3n_slam_on(u3k(raq), u3nc(u3k(puq_vex), u3k(puq_yit))));
      if ( u3_nul == vux ) {
        ret = u3nc(yur, u3k(q_vex));
      }
      else {
        ret = u3nq(yur, u3_nul, u3k(u3t(vux)), u3k(quq_yit));
        u3z(vux);
      }
    }
    u3z(yit);
...
u3we_bend_fun(u3_noun cor)
{
  ...
  if ( (c3n
        == u3r_mean(cor, u3x_sam_2, &vex, u3x_sam_3, &sab, u3x_con, &van, 0))
 ...
 */
static u3_noun
_cqe_cold_fun(u3_noun cus, u3_noun sef, u3_noun tub)
{
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    ret = u3nq(u3k(p_vex), u3_nul, u3k(cus), u3k(quq_vex));
 ...
 */
static u3_noun
_cqe_cook_fun(u3_noun poq, u3_noun sef, u3_noun tub)
{
  u3_noun vex = u3x_good(u3n_slam_on(u3k(sef), u3k(tub)));
  u3_noun p_vex, q_vex;
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    ret = u3nq(u3k(p_vex), u3_nul, wag, u3k(quq_vex));
 ...
 */
static u3_noun
_cqe_comp_fun(u3_noun raq, u3_noun vex, u3_noun sab)
{
  u3_noun p_vex, q_vex;
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    if ( c3n == u3du(q_yit) ) {
      ...
      ret = u3nq(
        yur,
        u3_nul,
        u3x_good(u3n_slam_on(u3k(raq), u3nc(u3k(puq_vex), u3k(puq_yit)))),
        u3k(quq_yit));
    }
    u3z(yit);
    return ret;
 ...
 */
static u3_noun
_cqe_easy_fun(u3_noun huf, u3_noun tub)
{
  u3_noun p_tub, q_tub;

  u3x_cell(tub, &p_tub, &q_tub);
  return u3nq(u3k(p_tub), u3_nul, u3k(huf), u3k(tub));
}
 ...
 */
static u3_noun
_cqe_glue_fun(u3_noun bus, u3_noun vex, u3_noun sab)
{
  u3_noun p_vex, q_vex;
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    if ( c3n == u3du(q_yit) ) {
      ...
      if ( c3n == u3du(q_wam) ) {
        ...
        ret = u3nq(goy, u3_nul, u3nc(u3k(puq_vex), u3k(puq_wam)), u3k(quq_wam));
      }
      u3z(wam);
    }
    u3z(yit);
 ...
 */
static u3_noun
_cqe_here_fun(u3_noun hez, u3_noun sef, u3_noun tub)
{
  u3_noun vex = u3x_good(u3n_slam_on(u3k(sef), u3k(tub)));
  u3_noun p_vex, q_vex;
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    gud = u3nc(u3nc(u3k(p_tub), u3k(pquq_vex)), u3k(puq_vex));
 ...
 */
static u3_noun
_cqe_just_fun(u3_noun daf, u3_noun tub)
{
  u3_noun p_tub, q_tub;
 ...
 */
static u3_noun
_cqe_mask_fun(u3_noun bud, u3_noun tub)
{
  u3_noun p_tub, q_tub;
 ...
 */
static u3_noun
_cqe_pfix(u3_noun vex, u3_noun sab)
{
  u3_noun p_vex, q_vex;
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    u3x_cell(yit, &p_yit, &q_yit);
    ret = u3nc(_last(p_vex, p_yit), u3k(q_yit));
 ...
 */
static u3_noun
_cqe_plug(u3_noun vex, u3_noun sab)
{
  u3_noun p_vex, q_vex;
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    if ( c3n == u3du(q_yit) ) {
      ...
      u3x_cell(uq_yit, &puq_yit, &quq_yit);
      ret = u3nq(yur, u3_nul, u3nc(u3k(puq_vex), u3k(puq_yit)), u3k(quq_yit));
    }
    u3z(yit);
    return ret;
  }
 ...
 */
u3_noun
u3qe_pose(u3_noun vex, u3_noun sab)
{
  u3_noun p_vex, q_vex;
  ...
  if ( c3y == u3du(q_vex) ) {
    ...
    ret = u3nc(_last(p_vex, p_roq), u3k(q_roq));
...
_cqe_sfix(u3_noun vex, u3_noun sab)
{
  ...
  if ( c3n == u3du(q_vex) ) {
    ...
    if ( c3n == u3du(q_yit) ) {
      ...
      ret = u3nq(yur, u3_nul, u3k(puq_vex), u3k(quq_yit));
    }
    u3z(yit);
    return ret;
  }
 ...
 */
static u3_noun
_cqe_shim_fun(u3_noun zep, u3_noun tub)
{
  u3_noun p_tub, q_tub;
  ...
  if ( c3n == u3du(q_tub) ) {
    ...
    if ( _(u3a_is_cat(p_zep)) && _(u3a_is_cat(q_zep)) && _(u3a_is_cat(iq_tub)) )
    {
 ...
 */
static u3_noun
_cqe_stag_fun(u3_noun gob, u3_noun sef, u3_noun tub)
{
  u3_noun vex = u3x_good(u3n_slam_on(u3k(sef), u3k(tub)));
  u3_noun p_vex, q_vex;
 ...
 */
static u3_noun
_stew_wor(u3_noun ort, u3_noun wan)
{
  if ( !_(u3a_is_cat(ort)) ) {
    return u3m_bail(c3__fail);
  }
    ...
    if ( c3n == u3du(wan) ) {
      ...
      if ( !_(u3a_is_cat(h_wan)) ) {
        ...
        return (ort < h_wan) ? c3y : c3n;
    }
  }
}

static u3_noun
_cqe_stew_fun(u3_noun hel, u3_noun tub)
{
  u3_noun p_tub, q_tub;
      ...
      while ( 1 ) {
        if ( c3n == u3du(hel) ) {
          ...
          if ( (c3n == u3du(pn_hel)) ) {
            ...
            if ( !_(u3a_is_cat(hpn_hel)) || !_(u3a_is_cat(tpn_hel)) ) {
              return _fail(tub);
            }
            else
              bit_o = __((iq_tub >= hpn_hel) && (iq_tub <= tpn_hel));
          }

          if ( c3y == bit_o ) {
            return u3x_good(u3n_slam_on(u3k(qn_hel), u3k(tub)));
          }
          else {
 ...
 */
static u3_noun
_cqe_stir_fun(u3_noun rud, u3_noun raq, u3_noun fel, u3_noun tub)
{
