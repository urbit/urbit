...
static void
_cqea_encode_ads(u3_noun ads, c3_w mat_w, urcrypt_aes_siv_data* dat_u)
{
  c3_w                  met_w;
  u3_noun               i, t;
...
static u3_noun
_cqea_siva_en(u3_atom key, u3_noun ads, u3_atom txt)
{
  if ( u3r_met(3, key) > 32 ) {
    return u3_none;
  }
...
static u3_noun
_cqea_siva_de(u3_atom key, u3_noun ads, u3_atom iv, u3_atom len, u3_atom txt)
{
  if ( u3r_met(3, key) > 32 ) {
    return u3_none;
  }
...
static u3_noun
_cqea_sivb_en(u3_atom key, u3_noun ads, u3_atom txt)
{
  if ( u3r_met(3, key) > 48 ) {
    return u3_none;
  }
...
static u3_noun
_cqea_sivb_de(u3_atom key, u3_noun ads, u3_atom iv, u3_atom len, u3_atom txt)
{
  if ( u3r_met(3, key) > 48 ) {
    return u3_none;
  }
...
static u3_noun
_cqea_sivc_en(u3_atom key, u3_noun ads, u3_atom txt)
{
  if ( u3r_met(3, key) > 64 ) {
    return u3_none;
  }
...
static u3_noun
_cqea_sivc_de(u3_atom key, u3_noun ads, u3_atom iv, u3_atom len, u3_atom txt)
{
  if ( u3r_met(3, key) > 64 ) {
    return u3_none;
  }
