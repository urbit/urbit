...
static u3_atom
_cqe_shay(u3_atom wid, u3_atom dat)
{
  c3_w len_w;
...
static u3_atom
_cqe_shal(u3_atom wid, u3_atom dat)
{
  c3_w len_w;
  if ( !u3r_word_fit(&len_w, wid) ) {
    return u3m_bail(c3__fail);
...
static u3_atom
_cqe_shas(u3_atom sal, u3_atom ruz)
{
  c3_w  sal_w, ruz_w;
...
u3we_shay(u3_noun cor)
{
  ...
  if ( (u3_none == (a = u3r_at(u3x_sam_2, cor)))
       || (u3_none == (b = u3r_at(u3x_sam_3, cor))) || (c3n == u3ud(a))
       || (c3n == u3ud(b)) )
  {
    return u3m_bail(c3__exit);
  }
...
u3we_shas(u3_noun cor)
{
  ...
  if ( (u3_none == (sal = u3r_at(u3x_sam_2, cor)))
       || (u3_none == (ruz = u3r_at(u3x_sam_3, cor))) || (c3n == u3ud(sal))
       || (c3n == u3ud(ruz)) )
  {
    return u3m_bail(c3__exit);
  }
...
static u3_noun
_og_list(u3_noun a, u3_noun b, u3_noun c)
{
  u3_noun l = u3_nul;
