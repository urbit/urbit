...
_lext(u3_loss* loc_u, u3_noun kad)
{
  if ( u3_nul == kad ) {
    ...
    return u3nc(u3k(loc_u->hev[u3r_word(0, u3h(kad))]), _lext(loc_u, u3t(kad)));
  }
}
...
_lexs(u3_loss* loc_u)
{
  if ( 0 == loc_u->kct_w ) {
    ...
    return u3kb_flop(_lext(loc_u, loc_u->kad[loc_u->kct_w - 1]));
}

//  initialize loss object
//
static void
_lemp(u3_loss* loc_u, u3_noun hel, u3_noun hev)
{
  loc_u->hel   = hel;
  ...
  loc_u->kct_w = 0;
  loc_u->kad
    = u3a_malloc((1 + c3_min(loc_u->lev_w, loc_u->lel_w)) * sizeof(u3_noun));
  ...
  loc_u->sev = u3_nul;
  {
    ...
    for ( i_w = 0; i_w < loc_u->lev_w; i_w++ ) {
      ...
      teg        = u3nc(u3i_words(1, &i_w), (hav == u3_none) ? u3_nul : hav);
...
//
static void
_lune(u3_loss* loc_u, c3_w inx_w, c3_w goy_w)
{
  u3_noun kad;

  kad = u3nc(u3i_words(1, &goy_w),
             (inx_w == 0) ? u3_nul : u3k(loc_u->kad[inx_w - 1]));
...
//
static u3_noun
_hink(u3_loss* loc_u, c3_w inx_w, c3_w goy_w)
{
  return __((loc_u->kct_w == inx_w)
...
//
static u3_noun
_lonk(u3_loss* loc_u, c3_w inx_w, c3_w goy_w)
{
  return __((0 == inx_w) || (u3r_word(0, u3h(loc_u->kad[inx_w - 1])) < goy_w));
}
...
//
static u3_noun
_bink(u3_loss* loc_u, c3_w* inx_w, c3_w max_w, c3_w goy_w)
{
...
static void
_merg(u3_loss* loc_u, c3_w inx_w, u3_noun gay)
{
...
u3_noun
u3qe_loss(u3_noun hel, u3_noun hev)
{
  u3_loss loc_u;
  u3_noun lcs;
...
u3we_loss(u3_noun cor)
{
  ...
  if ( (u3_none == (hel = u3r_at(u3x_sam_2, cor)))
       || (u3_none == (hev = u3r_at(u3x_sam_3, cor))) || (c3n == _listp(hel))
       || (c3n == _listp(hev)) )
  {
