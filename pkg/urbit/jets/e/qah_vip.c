...
u3_noun
u3qe_qah_vip(u3_noun a, u3_noun k, u3_noun p, u3_noun v)
{
  if (u3_nul == a) {
  ...
  if (c3n == u3ud(hoc)) {
    ...
    case c3__tip: {
      ...
      if (c3y == u3r_sing(k, ka)) {
        ...
        u3_noun pro = u3qe_qah_rule(ka, pa, va, pre, u3_nul);
    ...
    case c3__bin: {
      ...
      if (c3y == u3qe_qah_feud(ma, k, ka)) {
        u3_noun tee = u3qe_qah_fuse(ma, la, ra);
        u3_noun rof = u3nq(c3__tip, u3k(k), u3k(p), u3k(v));
        u3_noun pro = u3qe_qah_rule(ka, pa, va, rof, tee);
        ...
        if (c3y == u3qe_qah_zero(ma, k)) {
          u3_noun pre = u3qe_qah_raw(la, k, p, v);
          u3_noun pro = u3qe_qah_fuse(ma, pre, ra);
          ...
          u3_noun pre = u3qe_qah_raw(ra, k, p, v);
          u3_noun pro = u3qe_qah_fuse(ma, la, pre);
        ...
        return u3nq(c3__bin, u3k(ka), u3k(pa),
                 u3nq(u3k(va), u3k(ma), u3qe_qah_vip(la, k, p, v),
                   u3k(ra)));
      }
      else {
        return u3nq(c3__bin, u3k(ka), u3k(pa),
                 u3nq(u3k(va), u3k(ma), u3k(la),
                   u3qe_qah_vip(ra, k, p, v)));
      }
    }
  }
}
