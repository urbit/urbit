...
typedef int (*urcrypt_cbc)(c3_y**, size_t*, c3_y*, c3_y*, urcrypt_realloc_t);
...
static u3_atom
_cqea_cbca_en(u3_atom key, u3_atom iv, u3_atom msg)
{
  c3_y key_y[16];
...
u3wea_cbca_en(u3_noun cor)
{
  ...
  if ( c3n == u3r_mean(cor, u3x_sam, &c, 60, &a, 61, &b, 0) || c3n == u3ud(a)
       || c3n == u3ud(b) )
  {
...
static u3_atom
_cqea_cbca_de(u3_atom key, u3_atom iv, u3_atom msg)
{
  c3_y key_y[16];
  u3r_bytes(0, 16, key_y, key);
...
static u3_atom
_cqea_cbcb_en(u3_atom key, u3_atom iv, u3_atom msg)
{
  c3_y key_y[24];
...
static u3_atom
_cqea_cbcb_de(u3_atom key, u3_atom iv, u3_atom msg)
{
  c3_y key_y[24];
  u3r_bytes(0, 24, key_y, key);
...
static u3_atom
_cqea_cbcc_en(u3_atom key, u3_atom iv, u3_atom msg)
{
  c3_y key_y[32];
...
static u3_atom
_cqea_cbcc_de(u3_atom key, u3_atom iv, u3_atom msg)
{
  c3_y key_y[32];
  u3r_bytes(0, 32, key_y, key);
