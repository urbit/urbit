 ...
 */
static u3_atom
_cqee_add_double_scalarmult(u3_atom a, u3_atom b, u3_atom c, u3_atom d)
{
  c3_y a_y[32], b_y[32], c_y[32], d_y[32], out_y[32];

  if ( (0 != u3r_bytes_fit(32, a_y, a)) || (0 != u3r_bytes_fit(32, b_y, b))
       || (0 != u3r_bytes_fit(32, c_y, c)) || (0 != u3r_bytes_fit(32, d_y, d))
