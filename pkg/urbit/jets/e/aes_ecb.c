...
static u3_atom
_cqea_ecba_en(u3_atom key, u3_atom blk)
{
  c3_y key_y[16];
...
u3wea_ecba_en(u3_noun cor)
{
  ...
  if ( c3n == u3r_mean(cor, u3x_sam, &b, u3x_con_sam, &a, 0) || c3n == u3ud(a)
       || c3n == u3ud(b) )
  {
...
static u3_atom
_cqea_ecba_de(u3_atom key, u3_atom blk)
{
  c3_y key_y[16];
  u3r_bytes(0, 16, key_y, key);
...
static u3_atom
_cqea_ecbb_en(u3_atom key, u3_atom blk)
{
  c3_y key_y[24];
...
static u3_atom
_cqea_ecbb_de(u3_atom key, u3_atom blk)
{
  c3_y key_y[24];
  u3r_bytes(0, 24, key_y, key);
...
static u3_atom
_cqea_ecbc_en(u3_atom key, u3_atom blk)
{
  c3_y key_y[32];
...
static u3_atom
_cqea_ecbc_de(u3_atom key, u3_atom blk)
{
  c3_y key_y[32];
  u3r_bytes(0, 32, key_y, key);
