...
u3_noun
u3qe_qat_rule(u3_atom k, u3_atom p, u3_noun v, u3_noun a, u3_noun b)
{
  u3_atom l = u3h(u3t(a));
  u3_atom m = u3qe_qat_peak(k, l);

  if (c3y == u3qe_qat_zero(m, l)) {
...
u3we_qat_rule(u3_noun cor)
{
       ...
       (c3n == u3du(a)) )
  {
    ...
    return u3qe_qat_rule(k, p, v, a, b);
  }
}
