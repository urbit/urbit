...
_omit(u3_noun b, u3_noun k)
{
  ...
  if (c3n == u3ud(hob)) {
    ...
    case c3__bin: {
      ...
      if (c3y == u3qe_qat_feud(mb, k, kb)) {
        return u3nc(u3k(b), u3_nul);
      }
      else if (c3y == u3r_sing(k, kb)) {
        return u3nc(u3qe_qat_fuse(mb, lb, rb), u3nt(u3_nul, u3k(pb), u3k(vb)));
      }
      else if (c3y == u3qe_qat_zero(mb, k)) {
        u3_noun med = _omit(lb, k);

        u3_noun pm, qm;
        u3x_cell(med, &pm, &qm);

        u3_noun pro = u3nc(u3qe_qat_funk(kb, pb, vb, mb, pm, rb), u3k(qm));
        ...
        return pro;
          ...
          u3_noun pro = u3nc(u3qe_qat_wane(kb, pb, vb, mb, lb, pm), u3k(qm));
...
u3_noun
u3qe_qat_pet(u3_noun a, u3_noun k)
{
