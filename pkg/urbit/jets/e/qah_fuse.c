...
u3_noun
u3qe_qah_fuse(u3_atom m, u3_noun l, u3_noun r)
{
  if ( u3_nul == l ) {
    return u3k(r);
  }
        ...
        if ( u3_nul == r ) {
          ...
          if ( c3n == u3ud(hor) )  {
            ...
            case c3__tip: {
              ...
              if ( c3y == u3qe_qah_lex(p_l, k_l, p_r, k_r) ) {
          ...
          if ( c3n == u3ud(hor) )  {
            ...
            case c3__tip: {
              ...
              if ( c3y == u3qe_qah_lex(p_l, k_l, p_r, k_r) ) {
                return u3nq(c3__bin, u3k(k_l), u3k(p_l),
                         u3nq(u3k(v_l), u3k(m),
                            u3qe_qah_fuse(m_l, l_l, r_l), u3k(r)));
              }
              else {
                return u3nq(c3__bin, u3k(k_r), u3k(p_r),
                         u3nq(u3k(v_r), u3k(m), u3k(l), u3_nul));
