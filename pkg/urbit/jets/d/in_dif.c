 ...
 */
static u3_noun
_i_dif_join(u3_noun d, u3_noun e)
{
  if ( u3_nul == d ) {
    return u3k(e);
  }
    ...
    if ( c3y == u3qc_mor(n_d, n_e) ) {
      ...
      return u3nt(u3k(n_d), u3k(l_d), _i_dif_join(r_d, e));
    }
    else {
      u3_noun l_e, r_e;
      u3x_cell(lr_e, &l_e, &r_e);

      return u3nt(u3k(n_e), _i_dif_join(d, l_e), u3k(r_e));
    }
  }
}
