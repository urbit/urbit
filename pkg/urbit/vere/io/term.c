...
/* _term_it_put_color(): put ansi color id on lin_w. RETAINS col.
*/
static void
_term_it_put_color(c3_w* lin_w,
                   u3_noun col)
{
  switch ( col ) {
    default:
...
/* _term_it_put_decoration(): put ansi sgr code on lin_w. RETAINS dec.
*/
static void
_term_it_put_decoration(c3_w* lin_w,
                        u3_noun dec)
{
  switch ( dec ) {
    default:
                   ...
                   u3_noun tub)
{
  ...
  //
  c3_w* lin_w = c3_malloc( 4 * (lec_w + (20 * tuc_w)) );
  ...
  c3_w sap_w = 0;
  {
    ...
    while ( u3_nul != nub ) {
      u3_noun nib   = u3t(u3h(nub));
      u3_noun tyl   = u3h(u3h(nub));
      u3_noun dec   = u3h(tyl);
      u3_noun bag   = u3h(u3t(tyl));
      u3_noun fog   = u3t(u3t(tyl));
      c3_o    tyl_o = c3n;
      ...
      if ( c3y == tyl_o )
      {
        ...
        //
        {
          ...
          while ( u3_nul != des ) {
            ...
            _term_it_put_decoration(&lin_w[i_w++], u3h(des));
            sap_w++;
            mor_o = c3y;
            des = u3t(des);
          }
        ...
        if ( u3_nul != bag ) {
          ...
          lin_w[i_w++] = '4';
          _term_it_put_color(&lin_w[i_w++], bag);
          sap_w += 2;
          mor_o = c3y;
        }
        ...
        if ( u3_nul != fog ) {
          ...
          lin_w[i_w++] = '3';
          _term_it_put_color(&lin_w[i_w++], fog);
          sap_w += 2;
          mor_o = c3y;
        }
