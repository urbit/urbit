...
{
  u3h_buck* hab_u
    = u3a_walloc(c3_wiseof(u3h_buck) + (len_w * c3_wiseof(u3h_slot)));
  hab_u->len_w = len_w;
  return hab_u;
}
...
{
  u3h_node* han_u
    = u3a_walloc(c3_wiseof(u3h_node) + (len_w * c3_wiseof(u3h_slot)));
  han_u->map_w = 0;
  return han_u;
}

static void
_ch_slot_put(u3h_slot*, u3_noun, c3_w, c3_w, c3_w*);
...
_ch_some_add(void* han_v, c3_w lef_w, c3_w rem_w, u3_noun kev, c3_w* use_w)
{
  if ( 0 == lef_w ) {
    ...
    return _ch_node_add((u3h_node*)han_v, lef_w, rem_w, kev, use_w);
}
...
_ch_slot_put(u3h_slot* sot_w, u3_noun kev, c3_w lef_w, c3_w rem_w, c3_w* use_w)
{
  if ( c3n == u3h_slot_is_noun(*sot_w) ) {
    void* hav_v
      = _ch_some_add(u3h_slot_to_node(*sot_w), lef_w, rem_w, kev, use_w);
...
_ch_trim_buck(u3h_root* har_u, u3h_slot* sot_w)
{
  ...
  for ( len_w = hab_u->len_w; har_u->arm_u.inx_w < len_w;
        har_u->arm_u.inx_w += 1 )
  {
  ...
  if ( !BIT_SET(map_w, bit_w) ) {
    ...
    if ( _(u3h_slot_is_noun(sot_w)) ) {
      ...
      if ( 0 == lef_w ) {
        ...
        return _ch_node_hum(hav_v, lef_w, rem_w, mug_w);
    }
  }
}
  ...
  if ( !BIT_SET(map_w, bit_w) ) {
    ...
    if ( _(u3h_slot_is_noun(sot_w)) ) {
      ...
      if ( 0 == lef_w ) {
        ...
        return _ch_node_git(hav_v, lef_w, rem_w, key);
    }
  }
}
 ...
 */
void
u3h_walk_with(u3p(u3h_root) har_p, void (*fun_f)(u3_noun, void*), void* wit)
{
  u3h_root* har_u = u3to(u3h_root, har_p);
  c3_w      i_w;
...
{
  u3_noun kov = u3h_slot_to_noun(sot_w);
  u3_noun kev = u3nc(u3a_take(u3h(kov)), fun_f(u3t(kov)));
...
_ch_take_node(u3h_slot sot_w, c3_w lef_w, u3_funk fun_f)
{
  ...
  for ( i_w = 0; i_w < len_w; i_w++ ) {
    ...
    nah_u->sot_w[i_w] = (c3y == u3h_slot_is_noun(tos_w))
                        ...
                        : (0 == lef_w) ? _ch_take_buck(tos_w, fun_f)
