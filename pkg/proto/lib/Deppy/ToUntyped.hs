...
toUntyped = \case
  ...
  Suc e         -> U.Suc (toUntyped e)
  Eqa e f       -> U.Eql (toUntyped e) (toUntyped f)
  Cas e cs | keysSet cs == setFromList [0, 1] ->
    U.Ift
      (toUntyped e)
      (toUntyped $ fromJust $ lookup 0 cs)
      (toUntyped $ fromJust $ lookup 1 cs)
