...
export type GetPoints = (address: EthAddress) => Promise<Ships>;
...
export class RollerRPCAPI {
   ...
   */
  // tslint:disable-next-line:max-line-length
  public getPoints: GetPoints = (...params) => {
    return this.request("getPoints", params);
  }
