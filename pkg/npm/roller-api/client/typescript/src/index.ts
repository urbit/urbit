 ...
 *
 */
export type  = Ship | EthAddress | Signature | From | TransferPointParams | SpawnParams | ConfigureKeysParams | SponsorshipParams | AddressParams | Hash | Hash32 | TransactionType | L2Data | Nonce | L2Point | Ships | ListOfPendingTxs | PendingTransaction | SpawnedPoints | UnspawnedPoints | SpawnsLeft | NextBatch | TransactionStatus | TransactionHistory | Success | Config | ListOfDNS | SerializedTx | NaiveState;
...
export type HashRawTransaction = (sig: Signature, from: From, tx: TransactionType, data: L2Data) => Promise<Hash>;
...
export class RollerRPCAPI {
  ...
  /**
   * Gets the number of points that haven't been spawned by a star or galaxy
   */
  // tslint:disable-next-line:max-line-length
  ...
  /**
   * Currently equivalent to prepareForSigning.
   */
  // tslint:disable-next-line:max-line-length
