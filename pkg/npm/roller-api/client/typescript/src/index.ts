 ...
 *
 */
export type  = Ship | EthAddress | Signature | From | TransferPointParams | SpawnParams | ConfigureKeysParams | SponsorshipParams | AddressParams | Hash | Hash32 | TransactionType | Nonce | L2Data | L2Point | Ships | ListOfPendingTxs | PendingTransaction | SpawnedPoints | UnspawnedPoints | NextBatch | TransactionStatus | TransactionHistory | Success | Config | ListOfDNS | NaiveState;
