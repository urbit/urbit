...
export type CryptoSuite = number;
 ...
 *
 */
export type  = Ship | EthAddress | Signature | From | TransferPointParams | SpawnParams | ConfigureKeysParams | SponsorshipParams | AddressParams | Hash32 | TransactionType | Nonce | L2Data | L2Point | Ships | Hash | ListOfPendingTxs | SpawnedPoints | NextBatch | TransactionStatus | TransactionHistory | Success | Config | ListOfDNS;
