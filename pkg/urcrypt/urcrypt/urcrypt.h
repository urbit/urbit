...
const char*
urcrypt_argon2(uint8_t                type, // one of the urcrpyt_argon2_*
               uint32_t               version,
               uint32_t               threads,
...
size_t
urcrypt_secp_prealloc_size(void);
// call this once at per context with high quality entropy
int
urcrypt_secp_init(urcrypt_secp_context* context, uint8_t entropy[32]);
...
int
urcrypt_keccak_224(const uint8_t* message, size_t length, uint8_t out[28]);
int
urcrypt_keccak_256(const uint8_t* message, size_t length, uint8_t out[32]);
int
urcrypt_keccak_384(const uint8_t* message, size_t length, uint8_t out[48]);
int
urcrypt_keccak_512(const uint8_t* message, size_t length, uint8_t out[64]);
#endif
