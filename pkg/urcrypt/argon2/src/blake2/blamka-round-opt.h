...
#  define SWAP_QUARTERS(A0, A1)                                                \
    do {                                                                       \
      SWAP_HALVES(A0, A1);                                                     \
      A0 = _mm512_permutexvar_epi64(_mm512_setr_epi64(0, 1, 4, 5, 2, 3, 6, 7), \
                                    A0);                                       \
      A1 = _mm512_permutexvar_epi64(_mm512_setr_epi64(0, 1, 4, 5, 2, 3, 6, 7), \
                                    A1);                                       \
    } while ( (void)0, 0 )
