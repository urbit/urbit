 ...
 */
int
libscrypt_scrypt(const uint8_t*,
                 size_t,
                 const uint8_t*,
                 size_t,
                 uint64_t,
 ...
 */
int
libscrypt_salt_gen(/*@out@*/ uint8_t* rand, size_t len);
...
/* Standard MCF is:
   ...
   Hash is 64 bytes, or 88 in Base64. Work order, salt and hash have separators
   (3) 3 + 6 + 24 + 88 + 3 + null byte = 125 This is rounded up to a multiple of
   four for alignment
*/
