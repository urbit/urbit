...
let
  ...
  qtbase_patches = [
    ./arch-patches/0001-Add-profile-for-cross-compilation-with-mingw-w64.patch
    ./arch-patches/0002-Ensure-GLdouble-is-defined-when-using-dynamic-OpenGL.patch
    ./arch-patches/0003-Use-external-ANGLE-library.patch
    ./arch-patches/0004-Fix-too-many-sections-assemler-error-in-OpenGL-facto.patch
    ./arch-patches/0005-Make-sure-.pc-files-are-installed-correctly.patch
    ./arch-patches/0006-Don-t-add-resource-files-to-LIBS-parameter.patch
    ./arch-patches/0007-Prevent-debug-library-names-in-pkg-config-files.patch
    ./arch-patches/0008-Fix-linking-against-shared-static-libpng.patch
    ./arch-patches/0009-Fix-linking-against-static-D-Bus.patch
    ./arch-patches/0010-Fix-linking-against-static-freetype2.patch
    ./arch-patches/0011-Fix-linking-against-static-harfbuzz.patch
    ./arch-patches/0012-Fix-linking-against-static-pcre.patch
    ./arch-patches/0013-Fix-linking-against-shared-static-MariaDB.patch
    ./arch-patches/0014-Fix-linking-against-shared-static-PostgreSQL.patch
    ./arch-patches/0015-Rename-qtmain-to-qt5main.patch
    ./arch-patches/0016-Build-dynamic-host-libraries.patch
    ./arch-patches/0017-Enable-rpath-for-build-tools.patch
    ./arch-patches/0018-Use-system-zlib-for-build-tools.patch
    ./arch-patches/0019-Disable-determing-default-include-and-lib-dirs-at-qm.patch
    ./arch-patches/0020-Use-.dll.a-as-import-lib-extension.patch
    ./arch-patches/0021-Merge-shared-and-static-library-trees.patch
    ./arch-patches/0022-Allow-usage-of-static-version-with-CMake.patch
    ./arch-patches/0023-Use-correct-pkg-config-static-flag.patch
    ./arch-patches/0024-Fix-qt5_wrap_ui-macro.patch
    ./arch-patches/0025-Ignore-errors-about-missing-feature-static.patch
    #./arch-patches/0026-Enable-anf-fix-use-of-iconv.patch
    ./arch-patches/0027-Ignore-failing-pkg-config-test.patch
    ./arch-patches/0028-Include-uiviewsettingsinterop.h-correctly.patch
    ./arch-patches/0029-Hardcode-linker-flags-for-libqwindows.dll.patch
    ./arch-patches/0030-Prevent-qmake-from-messing-static-lib-dependencies.patch
  ];
