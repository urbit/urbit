...
$host-g++ -I../include -I"$angle/include" -L"$angle/lib" -DGL_GLEXT_PROTOTYPES ../samples/hello_triangle/HelloTriangle.cpp ../samples/sample_util/SampleApplication.cpp -lGLESv2 -lEGL -o bin/hello_triangle
