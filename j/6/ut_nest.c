...
*/
  ...
  */
    static c3_o
    _nest_sint(u3_noun, u3_noun, c3_o, u3_noun, u3_noun);
    static c3_o
    _nest_dext(u3_noun, u3_noun, c3_o, u3_noun, u3_noun);
        ...
        if ( (c3n == u3du(qn_dab)) || (c3n == u3du(qn_hem)) ) {
          ...
          case c3__ash: {
            if ( c3__ash != u3h(qn_hem) ) {
              ...
              c3_o ret = _nest_dext(van, vis, tel, lon, gil);
          ...
          if ( c3n == ret ) {
            ...
            switch ( pq_sut ) {
              ...
              case c3__iron: {
                ...
                c3_o ret = _nest_dext(van, r_sam, tel, s_sam, gil);
              ...
              case c3__zinc: {
                ...
                c3_o ret = _nest_dext(van, s_pal, tel, r_pal, gil);
    ...
    if ( (c3n == u3du(sut)) ) switch ( sut ) {
      ...
      case c3__hold: p_sut = u3t(sut);
      {
        ...
        if ( (c3y == u3_cqdi_has(gil, hud)) ) {
          ...
          c3_o hiv = _nest_dext(van, fop, tel, ref, zoc);
  ...
  _nest_dext_to(
                ...
                u3_noun gil)
  {
    c3_o tyn = _nest_dext_in(van, sut, tel, ref, gil);
    ...
    if ( (c3n == u3du(ref)) ) {
      ...
      switch ( u3h(ref) ) {
        ...
        case c3__core: {
          ...
          c3_o hiv = _nest_dext(van, sut, tel, gam, gil);
        ...
        case c3__hold: {
          p_ref = u3t(ref);
          {
            ...
            if ( (c3y == u3_cqdi_has(gil, hud)) ) {
              ...
              {
                c3_o hiv = _nest_dext(van, sut, tel, gam, zoc);
...
*/
  ...
  u3_cwfu_nest(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_mean(cor, u3v_sam_2, &tel,
                                u3v_sam_3, &ref,
                                u3v_con, &van,
                                0)) ||
         (c3n == u3ud(tel)) || (tel > 1) ||
