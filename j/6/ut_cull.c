           ...
           u3_noun vil)
  {
    ...
    if ( u3_no == u3du(sut) ) switch ( sut ) {
      ...
      case c3__bull: u3_cx_cell(u3t(sut), &p_sut, &q_sut);
      {
        ...
        if ( u3_yes == u3_cr_sing(hic, q_sut) ) {
          ret = u3k(sut);
        } else {
...
*/
  ...
  u3_cwfu_cull(u3_noun cor)
  {
    ...
    if ( (u3_no == u3_cr_mean(cor, u3_cv_sam_2, &pol,
                                u3_cv_sam_6, &axe,
                                u3_cv_sam_7, &ref,
                                u3_cv_con, &van, 0)) ||
         (u3_no == u3ud(axe)) ||
                        ...
                        u3_noun ref)
  {
    ...
    if ( u3_none != pro ) {
      ...
      return u3_cz_save_4(fun_m, sut, pol, axe, ref, pro);
    }
  }
