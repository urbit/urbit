  ...
  */
                    ...
                    u3_noun pac)
  {
    if ( (u3_nul == pac) ) {
      ...
      {
        if ( (1 != axis) &&
             (u3_yes == u3_cr_sing(2, u3_cqc_cap(axis))) )
        {
  ...
  */
                    ...
                    u3_noun pac)
  {
    if ( (u3_nul == pac) ) {
      ...
      {
        if ( (1 != axis) &&
             (u3_yes == u3_cr_sing(3, u3_cqc_cap(axis))) )
        {
          u3_atom axis_tap = u3_cqc_mas(axis);
...
*/
                   ...
                   u3_noun cor)
  {
    ...
    if ( (u3_no == u3_cr_mean(cor, u3_cv_sam_2, &axe, u3_cv_sam_3, &pac, 0)) ||
         (u3_no == u3ud(axe)) )
    {
