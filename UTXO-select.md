...
=val1 500.000
=inval1 200.100
=inval2 200.000=inval1 200.100
=inval2 200.000
=u (utxo:btc [pos=0 (hexb:btc [wid=32 dat=0xc493.f6f1.4668.5f76.b44f.0c77.ca88.120c.b8bc.89f5.34fe.69b6.8288.27b9.74e6.8849]) height=3 value=0 ~])
=addr [%bech32 'bc1qcr8te4kr609gcawutmrza0j4xv80jy8z306fyu']
=addi [%.y %0 0 (sy ~[u(value val1)])]
=outputs ~[[[%bech32 'bc1q59u5epktervh6fxqay2dlph0wxu9hjnx6v8n66'] value=inval1 ~] [[%bech32 'bc1qlwd7mw33uea5m8r2lsnsrkc7gp2qynrxsfxpfm'] value=inval2 ~]]
=w *walt:bwsl
...
[vbytes=vbytes:(need utxbu) fee=(sub val1 (add inval1 (add inval2 (need uchng))))]
```
